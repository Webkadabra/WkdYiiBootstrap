(function (e) {
  ...
  i.prototype = {constructor:i, _process_options:function (t) {
    ...
    if (n.startDate !== -Infinity) {
      if (!!n.startDate) {
        if (n.startDate instanceof Date)n.startDate = this._local_to_utc(this._zero_time(n.startDate)); else n.startDate = h.parseDate(n.startDate, i, n.language)
      } else {
    ...
    if (n.endDate !== Infinity) {
      if (!!n.endDate) {
        if (n.endDate instanceof Date)n.endDate = this._local_to_utc(this._zero_time(n.endDate)); else n.endDate = h.parseDate(n.endDate, i, n.language)
      } else {
        n.endDate = Infinity
      }
    }
    ...
    if (this.isInline)return;
    var n = this.picker.outerWidth(), r = this.picker.outerHeight(), i = 10, s = t.width(), o = t.height(), u = t.scrollTop();
    ...
    if (this.o.orientation.x !== "auto") {
      ...
      if (f.left < 0)h -= f.left - i; else if (f.left + n > s)h = s - n - i
    }
    ...
    var e = new Date(this.date), t, n = false;
    ...
    this.picker.find("tfoot th.today").text(c[this.o.language].today).toggle(this.o.todayBtn !== false);
    this.picker.find("tfoot th.clear").text(c[this.o.language].clear).toggle(this.o.clearBtn !== false);
    this.updateNavArrows();
    this.fillMonths();
    ...
    while (p.valueOf() < v) {
      if (p.getUTCDay() == this.o.weekStart) {
        m.push("<tr>");
        if (this.o.calendarWeeks) {
          var y = new Date(+p + (this.o.weekStart - p.getUTCDay() - 7) % 7 * 864e5), b = new Date(+y + (7 + 4 - y.getUTCDay()) % 7 * 864e5), w = new Date(+(w = n(b.getUTCFullYear(), 0, 1)) + (7 + 4 - w.getUTCDay()) % 7 * 864e5), E = (b - w) / 864e5 / 7 + 1;
      ...
      if (this.o.beforeShowDay !== e.noop) {
        ...
        if (S === undefined)S = {}; else if (typeof S === "boolean")S = {enabled:S}; else if (typeof S === "string")S = {classes:S};
      ...
      switch (r[0].nodeName.toLowerCase()) {
        case"th":
          switch (r[0].className) {
            ...
            case"clear":
              var u;
              if (this.isInput)u = this.element; else if (this.component)u = this.element.find("input");
              if (u)u.val("").change();
        ...
        case"td":
          if (r.is(".day") && !r.is(".disabled")) {
            ...
            var l = this.viewDate.getUTCFullYear(), f = this.viewDate.getUTCMonth();
            if (r.is(".old")) {
              if (f === 0) {
                f = 11;
                l -= 1
  ...
  e.fn.datepicker = function (t) {
    ...
    if (r !== undefined)return r; else return this
  };
  var f = e.fn.datepicker.defaults = {autoclose:false, beforeShowDay:e.noop, calendarWeeks:false, clearBtn:false, daysOfWeekDisabled:[], endDate:Infinity, forceParse:true, format:"mm/dd/yyyy", keyboardNavigation:true, language:"en", minViewMode:0, orientation:"auto", rtl:false, startDate:-Infinity, startView:0, todayBtn:false, todayHighlight:false, weekStart:0};
