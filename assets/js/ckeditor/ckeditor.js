...
(function () {
  if (!window.CKEDITOR || !window.CKEDITOR.dom) {
    window.CKEDITOR || (window.CKEDITOR = function () {
      var a = {timestamp:"C7LG", version:"4.0 Beta", revision:"84696441e9", rnd:Math.floor(900 * Math.random()) + 100, _:{pending:[]}, status:"unloaded", basePath:function () {
    ...
    CKEDITOR.event || (CKEDITOR.event = function () {
      ...
      function () {
        ...
        c.prototype = {getListenerIndex:function (a) {
          for (var c = 0, b = this.listeners; c < b.length; c++)if (b[c].fn == a)return c;
          return-1
        }};
        return{define:function (c, b) {
          var i = a.call(this, c);
          CKEDITOR.tools.extend(i, b, true)
        }, on:function (c, b, i, f, e) {
          function g(a, e, g, k) {
            a = {name:c, sender:this, editor:a, data:e, listenerData:f,
              stop:g, cancel:k, removeListener:j};
    ...
    CKEDITOR.env || (CKEDITOR.env = function () {
      var a = navigator.userAgent.toLowerCase(), b = window.opera, c = {ie:eval("/*@cc_on!@*/false"), opera:!!b && b.version, webkit:a.indexOf(" applewebkit/") > -1, air:a.indexOf(" adobeair/") > -1, mac:a.indexOf("macintosh") > -1, quirks:document.compatMode == "BackCompat", mobile:a.indexOf("mobile") > -1, iOS:/(ipad|iphone|ipod)/.test(a), isCustomDomain:function () {
    ...
    (function () {
      ...
      CKEDITOR.tools = {arrayCompare:function (a, b) {
        ...
        for (var d = 0; d < a.length; d++)if (a[d] != b[d])return false;
        return true
      },
        clone:function (a) {
          var b;
          ...
          if (typeof(d = arguments[b - 1]) == "boolean")b--; else if (typeof(d =
          ...
          for (var a = [].concat(a), b, d = [], i = 0; i < a.length; i++)if (b = a[i])/
          @
          import|
          [
            {}
    ...
    CKEDITOR.dtd = function () {
      var a = CKEDITOR.tools.extend, b = {isindex:1, fieldset:1}, c = {input:1, button:1,
      ...
      return{$nonBodyContent:a({html:1}, r, p), $block:t, $blockLimit:{body:1, div:1, section:1, header:1, footer:1, nav:1, article:1, aside:1, figure:1, dialog:1, hgroup:1, meter:1, menu:1,
        ...
        hgroup:o, mark:k, time:k, meter:k, menu:k, command:k, keygen:k, output:k, progress:n, audio:n, video:n, details:n, datagrid:n, datalist:n}
    }();
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {appendTo:function (a, b) {
      a.append(this, b);
      return a
    }, clone:function (a, b) {
      ...
      for (var b = [], c = this.getDocument().$.documentElement, h = this.$; h && h != c;) {
        var d = h.parentNode;
        d && b.unshift(this.getIndex.call({$:h}, a));
        h = d
      }
      return b
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.window.prototype, {focus:function () {
      ...
      return{width:(b ? a.documentElement.clientWidth : a.body.clientWidth) || 0, height:(b ? a.documentElement.clientHeight : a.body.clientHeight) ||
        0}
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {type:CKEDITOR.NODE_ELEMENT, addClass:function (a) {
      ...
      setStyle:function (a, b) {
        ...
        function e(j, b) {
          if (/body|html/.test(a.getName()))a.getWindow().$.scrollBy(j, b); else {
        ...
        for (var c = this.$.attributes, b = b || {}, h = 0; h < c.length; h++) {
          ...
          if (!(i in b))if (i == "checked" && (f = this.getAttribute(i)))a.setAttribute(i, f); else if (d.specified || CKEDITOR.env.ie && d.nodeValue && i == "value") {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.documentFragment.prototype,
      CKEDITOR.dom.element.prototype, {type:CKEDITOR.NODE_DOCUMENT_FRAGMENT, insertAfterNode:function (a) {
        a = a.$;
        a.parentNode.insertBefore(this.$, a.nextSibling)
    ...
    (function () {
      function a(a, b) {
        ...
        if (this.current)j = this.current[p](false, m, i); else {
          if (a)j.type == CKEDITOR.NODE_ELEMENT && (j = d > 0 ? j.getChild(d - 1) : i(j, true) === false ? null : j.getPreviousSourceNode(true, m, i)); else {
            j = k;
            if (j.type ==
    ...
    (function () {
      function a(a) {
        ...
        return function (g) {
          if (c(g))return true;
          if (g.type == CKEDITOR.NODE_TEXT)if (CKEDITOR.env.ie && e.test(g.getText()) && !b && (!a || !g.getNext()))b = true; else {
      ...
      function b(a) {
        return function (b) {
          return!a && f(b) || (b.type == CKEDITOR.NODE_TEXT ? !CKEDITOR.tools.trim(b.getText()) || !!b.getParent().data("cke-bookmark") : b.getName()in CKEDITOR.dtd.$removeEmpty)
        }
      }
      ...
      var h = function (a) {
        ...
        if (f.type == CKEDITOR.NODE_TEXT)f = f.split(d); else if (f.getChildCount() > 0)if (d >= f.getChildCount()) {
        ...
        if (g.type == CKEDITOR.NODE_TEXT) {
          ...
          i = true
        } else g = g.getChild(h).getPrevious(); else {
        ...
        for (var w = c, x, y, z, D = t; D < h.length; D++) {
          ...
          for (x = x.getNext(); x;) {
            ...
            z = x.getNext();
            if (b == 2)w.append(x.clone(true)); else {
              x.remove();
              b == 1 && w.append(x)
            }
            x = z
        ...
        for (c = t; c < d.length; c++) {
          ...
          if (!h[c] || x.$.parentNode != h[c].$.parentNode)for (x = x.getPrevious(); x;) {
            ...
            z = x.getPrevious();
            if (b == 2)w.$.insertBefore(x.$.cloneNode(true), w.$.firstChild); else {
              x.remove();
      ...
      }, i = {abbr:1, acronym:1, b:1, bdo:1, big:1, cite:1, code:1, del:1, dfn:1, em:1, font:1, i:1, ins:1, label:1, kbd:1, q:1, samp:1, small:1, span:1, strike:1, strong:1, sub:1, sup:1, tt:1, u:1, "var":1}, f = CKEDITOR.dom.walker.bogus(), e = new CKEDITOR.dom.walker.whitespaces, g = new CKEDITOR.dom.walker.bookmark;
      CKEDITOR.dom.range.prototype = {clone:function () {
        ...
        return{startNode:a ? e + (f ? "C" : "S") : b, endNode:a ? e + "E" : c, serializable:a, collapsed:f}
        ...
        return{start:b.getAddress(a),
          end:f ? null : c.getAddress(a), startOffset:e, endOffset:g, normalized:a, collapsed:f, is2:true}
        ...
        if (b.type == CKEDITOR.NODE_ELEMENT) {
          g = b.getChildCount();
          if (g > e)b = b.getChild(e).getPreviousSourceNode(true); else if (g < 1)b = b.getPreviousSourceNode();
          else {
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            if (u.type == CKEDITOR.NODE_TEXT) {
              ...
              t = !(u && u.getLength());
              if (u && !(i = u.getNext()))d = u.getParent()
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            var z, D, J = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br:1} : null), B = function (a) {
              var b = J(a);
              b || (z = a);
              return b
            }, c = function (a) {
        ...
        if (!this.collapsed) {
          ...
          if (g && g.type == CKEDITOR.NODE_TEXT)if (h)if (h >= g.getLength())e.setStartAfter(g); else {
            e.setStartBefore(g);
            i = 0
          } else e.setStartBefore(g);
          if (f && f.type == CKEDITOR.NODE_TEXT)if (d)if (d >= f.getLength())e.setEndAfter(f); else {
            e.setEndAfter(f);
            r = 0
    ...
    (function () {
      ...
      a.prototype = {getNextParagraph:function (a) {
        ...
        for (this._.nextNode = null; n;) {
          ...
          if (p)n.type == CKEDITOR.NODE_TEXT && c.test(n.getText()) && (p = 0); else {
            var r = n.getName();
            if (n.isBlockBoundary(this.forceBrBreak && !m && {br:1})) {
              if (r == "br")p = 1; else if (!g && !n.getChildCount() && r != "hr") {
                e = n;
                j = n.equals(d);
                break
              }
          ...
          if (g && !o)for (; !n.getNext(i) && !j;) {
            r = n.getParent();
            if (r.isBlockBoundary(this.forceBrBreak && !m && {br:1})) {
              o = 1;
              p = 0;
              j || r.equals(d);
        ...
        if (!e) {
          ...
          o = {div:1, th:1, td:1};
          e = e.block;
          if (!e && n && !this.enforceRealBlocks && o[n.getName()] && g.checkStartOfBlock() && g.checkEndOfBlock() && !n.equals(g.root))e = n; else if (!e || this.enforceRealBlocks && e.getName() == "li") {
    ...
    CKEDITOR.command = function (a, b) {
      ...
      this.refresh =
        function (a, h) {
          ...
          this.enable();
          return this.fire("refresh", {editor:a, path:h}) === false ? true : b.refresh && b.refresh.apply(this, arguments) !== false
        };
      CKEDITOR.tools.extend(this, b, {modes:{wysiwyg:1}, editorFocus:1, contextSensitive:!!b.context, state:CKEDITOR.TRISTATE_OFF});
      CKEDITOR.event.call(this)
    };
    ...
    (function () {
      var a, b = function (b) {
        ...
        a = f.fire("key", {keyCode:c}) === false;
        if (!a) {
          i && (a = f.execCommand(i, {from:"keystrokeHandler"}) !== false);
    ...
    (function () {
      CKEDITOR.lang = {languages:{af:1, ar:1, bg:1, bn:1, bs:1, ca:1, cs:1, cy:1, da:1, de:1, el:1, "en-au":1, "en-ca":1, "en-gb":1, en:1, eo:1, es:1, et:1, eu:1, fa:1, fi:1, fo:1, "fr-ca":1, fr:1, gl:1, gu:1, he:1, hi:1, hr:1, hu:1, is:1, it:1, ja:1, ka:1, km:1, ko:1, lt:1, lv:1, mn:1, ms:1, nb:1, nl:1, no:1, pl:1, "pt-br":1, pt:1, ro:1, ru:1, sk:1, sl:1, "sr-latn":1, sr:1, sv:1, th:1, tr:1, uk:1, vi:1, "zh-cn":1, zh:1}, load:function (a, b, c) {
      ...
      return{load:function (c, h, d, i) {
        ...
        if (e === 0)k(true); else {
          var q = function (a, b) {
            ...
            if (a[c])q(c, true); else {
              var e = b[c] || (b[c] = []);
              e.push(q);
              if (!(e.length > 1)) {
                var g = new CKEDITOR.dom.element("script");
                g.setAttributes({type:"text/javascript", src:c});
    ...
    {add:function (a, b) {
      ...
      for (var a = a.split(","), h = 0; h < a.length; h++)this.externals[a[h]] = {dir:b, file:c}
    }, load:function (a, b, c) {
      ...
      return function (c, h, d) {
        var i = {}, f = function (c) {
          a.call(this, c, function (a) {
            ...
            if (c.length)f.call(this, c); else {
              for (e in i) {
                q = i[e];
    ...
    CKEDITOR.ui.prototype = {add:function (a, b, c) {
      c.name = a.toLowerCase();
      var h = this.items[a] = {type:b, command:c.command || null, args:Array.prototype.slice.call(arguments, 2)};
        ...
        CKEDITOR.plugins.load(c.split(","), function (c) {
          ...
          for (var j in c) {
            ...
            if (h && !a.lang[j]) {
              ...
              if (!d.langEntries || !d.langEntries[i])f.push(CKEDITOR.getUrl(d.path + "lang/" + i + ".js")); else {
    ...
    (function () {
      var a = /([\w\-:.]+)(?:(?:\s*=\s*(?:(?:"([^"]*)")|(?:'([^']*)')|([^\s>]+)))|(?=\s|$))/g, b = {checked:1, compact:1, declare:1, defer:1, disabled:1, ismap:1, multiple:1, nohref:1, noresize:1, noshade:1, nowrap:1, readonly:1, selected:1};
    ...
    CKEDITOR.htmlParser.comment.prototype = {type:CKEDITOR.NODE_COMMENT, writeHtml:function (a, b) {
      var c = this.value;
      if (b) {
    ...
    (function () {
      ...
      CKEDITOR.htmlParser.text.prototype = {type:CKEDITOR.NODE_TEXT, writeHtml:function (a, b) {
        var c = this.value;
    ...
    (function () {
      ...
      CKEDITOR.htmlParser.cdata.prototype = {type:CKEDITOR.NODE_TEXT, writeHtml:function (a) {
        a.write(this.value)
      }}
    })();
    ...
    (function () {
      ...
      var b = CKEDITOR.tools.extend({table:1, ul:1, ol:1, dl:1}, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), c = CKEDITOR.env.ie && CKEDITOR.env.version < 8 ? {dd:1, dt:1} : {}, h = {ol:1, ul:1}, d = CKEDITOR.tools.extend({}, {html:1}, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, {style:1, script:1});
            ...
            if (e == "br")o.push(f); else {
              for (; ;) {
                ...
                if (!f.isUnknown && !m.isUnknown && !l[e])if (m.isOptionalClose)q.onTagClose(i);
                  ...
                  m = i
                } else if (e in CKEDITOR.dtd.$listItem && i != e)q.onTagOpen(e == "li" ? "ul" : "dl", {}, 0, 1); else if (i in b && i != e) {
                  !f.returnPoint && (f.returnPoint = m);
                  m = m.parent
                } else {
                  i in CKEDITOR.dtd.$inline && n.unshift(m);
                  if (m.parent)k(m, m.parent, 1); else {
                    f.isOrphan = 1;
                    break
                  }
                } else break
      ...
      CKEDITOR.htmlParser.fragment.prototype = {add:function (a, b) {
    ...
    (function () {
      ...
      function h(a, e) {
        return function (g) {
          ...
          var j;
          j = !a;
          if (!j && (!e || typeof e == "function" && e(g) === false))j = false; else if (j && CKEDITOR.env.ie && (document.documentMode > 7 || g.name in CKEDITOR.dtd.tr || g.name in CKEDITOR.dtd.$listItem))j = false; else {
            j = b(g);
            j =
              g.children[j];
      ...
      function l(a, b) {
        for (var c = [], e = b.config.protectedSource, g = b._.dataStore || (b._.dataStore = {id:1}), j = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, e = [/<script[\s\S]*?<\/script>/gi,
      ...
      CKEDITOR.htmlDataProcessor.prototype = {toHtml:function (b, c, d) {
        if (typeof c != "string") {
          d = c;
          c = ""
        }
    ...
    CKEDITOR.htmlParser.cssStyle = function (a) {
      ...
      return{rules:b, populate:function (a) {
        var b = this.toString();
    ...
    (function () {
      ...
      function c(a) {
        var b = a.name, c = a.element, g = a.elementMode, j = a.fire("uiSpace", {space:"top", html:""}).html, h = a.fireOnce("uiSpace", {space:"bottom", html:""}).html, q = a.config.height;
        isNaN(q) || (q =
          q + "px");
        ...
        var o = CKEDITOR.dom.element.createFromHtml(d.output({id:a.id, name:b, langDir:a.lang.dir, langCode:a.langCode, voiceLabel:a.lang.editor, style:l ? ' style="' + l + '"' : "", height:q, topId:a.ui.spaceId("top"), topHtml:j || "", contentId:a.ui.spaceId("contents"), bottomId:a.ui.spaceId("bottom"), bottomHtml:h || ""}));
    ...
    (function () {
      ...
      function c(a, b) {
        return function (c) {
          ...
          f.equals(b) && (!d || !b.contains(d)) && a.call(this, c)
        }
      }
      ...
      CKEDITOR.editable = CKEDITOR.tools.createClass({base:CKEDITOR.dom.element, $:function (a, b) {
        ...
        for (var c = this.editor, j = c.config.enterMode, f = c.getSelection(), d = f.getRanges(), h = a.getName(), i = CKEDITOR.dtd.$block[h], o, m, p, s = d.length - 1; s >= 0; s--) {
          ...
          if (!o.checkReadOnly()) {
            ...
            m = !s && a || a.clone(1);
            var r, t;
            if (i)for (; (r = o.getCommonAncestor(0, 1)) && (t = CKEDITOR.dtd[r.getName()]) && (!t || !t[h]);)if (r.getName()in CKEDITOR.dtd.span)o.splitElement(r); else if (o.checkStartOfBlock() && o.checkEndOfBlock()) {
              o.setStartBefore(r);
              o.collapse(true);
              r.remove()
        ...
        if (p) {
          ...
          if (i)if ((a = p.getNext(b)) && a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$block))a.getDtd()["#"] ? o.moveToElementEditStart(a) :
            o.moveToElementEditEnd(p); else if (!a && j != CKEDITOR.ENTER_BR) {
      ...
      var f =
        function () {
          ...
          var o = CKEDITOR.dtd, m = {p:1, div:1, h1:1, h2:1, h3:1, h4:1, h5:1, h6:1, ul:1, ol:1, li:1, pre:1, dl:1, blockquote:1}, p = {p:1, div:1, h1:1,
            h2:1, h3:1, h4:1, h5:1, h6:1}, s = CKEDITOR.tools.extend({}, o.$inline);
          delete s.br;
          return function (m, t, u) {
            ...
            if (!w.checkReadOnly()) {
              var x = (new CKEDITOR.dom.elementPath(w.startContainer, w.root)).blockLimit || w.root, t = {type:t, editable:m, editor:v, range:w, blockLimit:x, mergeCandidates:[], zombies:[]};
              if (!a(t, u)) {
                ...
                if (u) {
                  ...
                  for (var N = H.getChildren(), R = N.count(), S = -1, U = -1, V = 0; C < R; ++C) {
                    ...
                    if (f(H)) {
                      ...
                      S == -1 && !Q && (S = C);
                      Q || (U = C);
                      F.push({isElement:1, isLineBreak:V, isBlock:H.isBlockBoundary(), hasBlockSibling:G, node:H, name:M, allowed:Q});
                      G = V = 0
                    } else F.push({isElement:0, node:H, allowed:1})
                  }
                  ...
                  for (n(F, E); B < F.length; B++) {
                    ...
                    if (A = G.isLineBreak) {
                      ...
                      if (G.hasBlockSibling)A = 1; else {
                        ...
                        if (!H || !H.is({div:1, p:1}))A = 0; else {
                          M = H.getPosition(C);
                          if (M == CKEDITOR.POSITION_IDENTICAL || M == CKEDITOR.POSITION_CONTAINS)A = 0; else {
                            C = A.splitElement(H);
                ...
                if (!t.dontMoveCaret) {
                  for (L = f(K.startContainer) && K.startContainer.getChild(K.startOffset - 1); L && f(L) && !L.is(o.$empty);) {
                    if (L.isBlockBoundary())K.moveToPosition(L, CKEDITOR.POSITION_BEFORE_END); else {
    ...
    (function () {
      ...
      CKEDITOR.dom.selection = function (a) {
        ...
        a = this.getNative();
        if (a.getRangeAt)c = (c =
          a.rangeCount && a.getRangeAt(0)) && new CKEDITOR.dom.node(c.commonAncestorContainer); else {
          try {
            c = a.createRange()
          } catch (g) {
          }
      ...
      var g = {img:1, hr:1, li:1, table:1, tr:1, td:1, th:1, embed:1, object:1, ol:1,
        ul:1, a:1, input:1, form:1, select:1, textarea:1, button:1, fieldset:1, thead:1, tfoot:1};
      CKEDITOR.dom.selection.prototype = {getNative:function () {
          ...
          function () {
            ...
            var b = function (b, c) {
              ...
              for (var f = g.children, d, h, j = b.duplicate(), i = 0, q = f.length - 1, w = -1, x, y; i <= q;) {
                ...
                if (x > 0)q = w - 1; else if (x < 0)i = w + 1; else {
                  if (CKEDITOR.env.ie9Compat && d.tagName == "BR") {
                    f = e.defaultView.getSelection();
                    return{container:f[c ?
                      "anchorNode" : "focusNode"], offset:f[c ? "anchorOffset" : "focusOffset"]}
                  }
                  return{container:g, offset:a(d)}
                }
              }
              if (w == -1 || w == f.length - 1 && x < 0) {
                ...
                if (!e) {
                  d = f[f.length - 1];
                  return d.nodeType != CKEDITOR.NODE_TEXT ? {container:g, offset:f.length} : {container:d, offset:d.nodeValue.length}
                }
                ...
                return{container:y, offset:-e}
              }
              j.collapse(x >
                0 ? true : false);
              j.setEndPoint(x > 0 ? "StartToStart" : "EndToStart", b);
              e = j.text.replace(/(\r\n|\r)/g, "\n").length;
              if (!e)return{container:g, offset:a(d) + (x > 0 ? 0 : 1)};
              for (; e > 0;)try {
              ...
              return{container:y, offset:x > 0 ? -e : y.nodeValue.length + e}
            };
            return function () {
        ...
        var b = this, c = CKEDITOR.tools.tryThese(function () {
          ...
          var a, c, g = b.getRanges()[0], e = g.getCommonAncestor(1, 1), f = {table:1, ul:1, ol:1, dl:1}, d;
          for (d in f)if (a = e.getAscendant(d, 1))break;
          if (a) {
        ...
        if (a.length)if (this.isLocked) {
          ...
          if (CKEDITOR.env.ie) {
            var c = CKEDITOR.dom.walker.whitespaces(true), e = /\ufeff|\u00a0/, f = {table:1, tbody:1, tr:1};
            if (a.length > 1) {
              b = a[a.length - 1];
            ...
            (b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName()in f || b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName()in f) && b.shrink(CKEDITOR.NODE_ELEMENT, true);
            p = b.createBookmark();
            var f = p.startNode, t;
            if (!a)t = p.endNode;
    ...
    (function () {
      function a(a, b) {
        for (var c, g; a = a.getParent();) {
          if (a.equals(b))break;
          if (a.getAttribute("data-nostyle"))c = a; else if (!g) {
            var e =
          ...
          for (n.getPosition(q) == CKEDITOR.POSITION_FOLLOWING && (n = 0); n;) {
            ...
            if (d && o && !o.collapsed) {
              for (var d = m(this, c), p = d.hasAttributes(), r = o.getCommonAncestor(),
                     u = {}, s = {}, x = {}, v = {}, w, y, D; d && r;) {
                if (r.getName() == g) {
                  for (w in e.attributes)if (!v[w] && (D = r.getAttribute(y)))d.getAttribute(w) == D ? s[w] = 1 : v[w] = 1;
                  for (y in e.styles)if (!x[y] && (D = r.getStyle(y)))d.getStyle(y) == D ? u[y] = 1 : x[y] = 1
                }
                r = r.getParent()
              }
      ...
      function d(a) {
        ...
        if (a = (new CKEDITOR.dom.elementPath(b, a.root)).contains(this.element, 1)) {
          ...
          if (c)for (var g in c)a.removeAttribute(g, c[g]);
      ...
      function o(a, b) {
        if (!a.hasAttributes() || b)if (CKEDITOR.dtd.$block[a.getName()]) {
          ...
          g && (g.type == CKEDITOR.NODE_TEXT || !g.isBlockBoundary({br:1})) && a.append("br");
          a.remove(true)
        } else {
          c = a.getFirst();
          g = a.getLast();
      ...
      function p(a, b) {
        ...
        if (g)for (var e in g)a.setAttribute(e, g[e]);
      ...
      var v = {address:1, div:1, h1:1, h2:1, h3:1, h4:1, h5:1, h6:1, p:1, pre:1, section:1, header:1, footer:1, nav:1, article:1, aside:1, figure:1, dialog:1, hgroup:1, time:1, meter:1, menu:1, command:1, keygen:1, output:1, progress:1, details:1, datagrid:1, datalist:1}, w = {a:1, embed:1, hr:1, img:1, li:1, object:1, ol:1, table:1, td:1, tr:1, th:1, ul:1, dl:1, dt:1, dd:1, form:1, audio:1, video:1}, x = /\s*(?:;\s*|$)/, y = /#\((.+?)\)/g, z = CKEDITOR.dom.walker.bookmark(0, 1), D = CKEDITOR.dom.walker.whitespaces(1);
    ...
    CKEDITOR.dom.elementPath.prototype = {compare:function (a) {
      ...
      for (b = 0; b < i; b++)if (h(d[b]))return d[b];
      return null
          ...
          if (e && a.length > 1) {
            ...
            if (f)for (var j = 0; a[i + j + 1];) {
              for (var k = e.document, f = 0, g = k.getById(d[j].endNode), k = k.getById(d[j + 1].startNode); ;) {
                ...
                if (k.equals(g))f = 1; else if (b(g) || g.type == CKEDITOR.NODE_ELEMENT && g.isBlockBoundary())continue;
                break
              }
              if (!f)break;
              j++
    ...
    (function () {
      ...
      var i = {};
      CKEDITOR.skin = {path:a, loadPart:function (b, g) {
      ...
      CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {getUiColor:function () {
        ...
        return(this.setUiColor = function (a) {
          var c = CKEDITOR.skin.chameleon, f = [
            [g, a]
          ];
          this.uiColor = a;
          d([b], c(this, "editor"), f);
    ...
    CKEDITOR.plugins.add("dialogui", {onLoad:function () {
      ...
      }}, d = CKEDITOR.tools.extend({}, CKEDITOR.ui.dialog.uiElement.prototype.eventProcessors, {onChange:function (a, b) {
      ...
      CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {labeledElement:function (b, c, f, d) {
        if (!(arguments.length < 4)) {
          var h = a.call(this, c);
          h.labelId = CKEDITOR.tools.getNextId() + "_label";
          this._.children = [];
          CKEDITOR.ui.dialog.uiElement.call(this, b, c, f, "div", null, {role:"presentation"}, function () {
            var a = [], f = c.required ?
              " cke_required" : "";
            if (c.labelLayout != "horizontal")a.push('<label class="cke_dialog_ui_labeled_label' + f + '" ', ' id="' + h.labelId + '"', h.inputId ? ' for="' + h.inputId + '"' : "", (c.labelStyle ? ' style="' + c.labelStyle + '"' : "") + ">", c.label, "</label>", '<div class="cke_dialog_ui_labeled_content"' + (c.controlStyle ? ' style="' + c.controlStyle + '"' : "") + ' role="presentation">', d.call(this, b, c), "</div>"); else {
              f = {type:"hbox", widths:c.widths, padding:0, children:[
                {type:"html", html:'<label class="cke_dialog_ui_labeled_label' + f +
                  '" id="' + h.labelId + '" for="' + h.inputId + '"' + (c.labelStyle ? ' style="' + c.labelStyle + '"' : "") + ">" + CKEDITOR.tools.htmlEncode(c.label) + "</span>"},
                {type:"html", html:'<span class="cke_dialog_ui_labeled_content"' + (c.controlStyle ? ' style="' + c.controlStyle + '"' : "") + ">" + d.call(this, b, c) + "</span>"}
              ]};
        ...
        if (!(arguments.length < 3)) {
          a.call(this, c);
          var d = this._.inputId = CKEDITOR.tools.getNextId() + "_textInput", h = {"class":"cke_dialog_ui_input_" +
            c.type, id:d, type:c.type};
        ...
        if (!(arguments.length < 3)) {
          var h = a.call(this, c, {"default":!!c["default"]});
          if (c.validate)this.validate = c.validate;
          CKEDITOR.ui.dialog.uiElement.call(this, b, c, d, "span", null, null, function () {
            var a = CKEDITOR.tools.extend({}, c, {id:c.id ? c.id + "_checkbox" : CKEDITOR.tools.getNextId() + "_checkbox"}, true), d = [], j = CKEDITOR.tools.getNextId() + "_label", i = {"class":"cke_dialog_ui_checkbox_input", type:"checkbox", "aria-labelledby":j};
            f(a);
          ...
          CKEDITOR.ui.dialog.labeledElement.call(this,
            b, c, d, function () {
              for (var a = [], d = [], j = c.id ? c.id + "_radio" : CKEDITOR.tools.getNextId() + "_radio", m = 0; m < c.items.length; m++) {
                var p = c.items[m], s = p[2] !== void 0 ? p[2] : p[0], r = p[1] !== void 0 ? p[1] : p[0], t = CKEDITOR.tools.getNextId() + "_radio_input", u = t + "_label", t = CKEDITOR.tools.extend({}, c, {id:t, title:null, type:null}, true), s = CKEDITOR.tools.extend({}, t, {title:s}, true), v = {type:"radio", "class":"cke_dialog_ui_radio_input", name:j, value:r, "aria-labelledby":u}, w = [];
                ...
                w.push(" ");
                new CKEDITOR.ui.dialog.uiElement(b, s, w, "label", null, {id:u, "for":v.id}, p[0]);
                a.push(w.join(""))
              }
        ...
        if (arguments.length) {
          ...
          b.on("load", function () {
            ...
            (function () {
              a.on("click", function (a) {
                d.fire("click", {dialog:d.getDialog()});
                a.data.preventDefault()
              });
          ...
          CKEDITOR.ui.dialog.uiElement.call(this, b, h, f, "a", null, {style:c.style, href:"javascript:void(0)", title:c.label, hidefocus:"true", "class":c["class"], role:"button", "aria-labelledby":i}, '<span id="' +
        ...
        if (!(arguments.length < 3)) {
          ...
          CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function () {
            var a = CKEDITOR.tools.extend({}, c, {id:c.id ? c.id + "_select" : CKEDITOR.tools.getNextId() + "_select"}, true), d = [], j = [], i = {id:h.inputId, "class":"cke_dialog_ui_input_select", "aria-labelledby":this._.labelId};
        ...
        if (!(arguments.length < 3)) {
          ...
          var d = CKEDITOR.tools.extend(a.call(this, c), {definition:c, buttons:[]});
          if (c.validate)this.validate = c.validate;
          b.on("load", function () {
      ...
      CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, h, {getInputElement:function () {
        ...
        submit:function () {
          ...
          for (d in a)if (c = d.match(b))this.eventProcessors[d] ? this.eventProcessors[d].call(this, this._.dialog, a[d]) : f(this, this._.dialog, c[1].toLowerCase(), a[d]);
          return this
        }, reset:function () {
          function a() {
            c.$.open();
      ...
      CKEDITOR.dialog.addUIElement("fieldset", {build:function (a, b, c) {
    ...
    (function () {
      ...
      function b() {
        for (var a =
          this._.tabIdList.length, b = CKEDITOR.tools.indexOf(this._.tabIdList, this._.currentTabId), c = b + 1; c < b + a; c++)if (this._.tabs[this._.tabIdList[c % a]][0].$.offsetHeight)return this._.tabIdList[c % a];
        return null
      }
      ...
      function i(a) {
        var a = CKEDITOR.dom.element.createFromHtml(CKEDITOR.addTemplate("dialog", o).output({id:CKEDITOR.tools.getNextNumber(), editorId:a.id, langDir:a.lang.dir, langCode:a.langCode,
          editorDialogClass:"cke_editor_" + a.name.replace(/\./g, "\\.") + "_dialog", closeTitle:a.lang.common.close})), b = a.getChild([0, 0, 0, 0, 0]), c = b.getChild(0), f = b.getChild(1);
        ...
        c.unselectable();
        f.unselectable();
        return{element:a, parts:{dialog:a.getChild(0), title:c, close:f, tabs:b.getChild(2), contents:b.getChild([3, 0, 0, 0]), footer:b.getChild([3, 0, 1, 0])}}
      }
      ...
      CKEDITOR.dialog = function (c, f) {
        ...
        p = new t(this, p);
        q = i(c);
        this._ = {editor:c, element:q.element, name:f, contentSize:{width:0, height:0}, size:{width:0, height:0}, contents:{}, buttons:{}, accessKeyMap:{}, tabs:{}, tabIdList:[], currentTabId:null,
        ...
        q = {position:CKEDITOR.env.ie6Compat ? "absolute" : "fixed", top:0, visibility:"hidden"};
        q[u == "rtl" ? "right" : "left"] = 0;
        this.parts.dialog.setStyles(q);
        CKEDITOR.event.call(this);
        this.definition = p = CKEDITOR.fire("dialogDefinition", {name:f, definition:p}, c).definition;
        ...
        s = CKEDITOR.dialog._.uiElementBuilders.hbox.build(this,
          {type:"hbox", className:"cke_dialog_footer_buttons", widths:[], children:p.buttons}, u).getChild();
      ...
      CKEDITOR.dialog.prototype = {destroy:function () {
        ...
        var b = [], c = a.label ? ' title="' + CKEDITOR.tools.htmlEncode(a.label) + '"' : "", d = CKEDITOR.dialog._.uiElementBuilders.vbox.build(this, {type:"vbox", className:"cke_dialog_page_contents", children:a.elements, expand:!!a.expand, padding:a.padding, style:a.style || "width: 100%;height:100%"}, b), b = CKEDITOR.dom.element.createFromHtml(b.join(""));
        ...
        if (this._.currentTabId != a && this.fire("selectPage", {page:a, currentPage:this._.currentTabId}) !== true) {
      ...
      CKEDITOR.tools.extend(CKEDITOR.dialog, {add:function (a, b) {
        ...
        okButton:function () {
          ...
          var a = function (a, b) {
            b = b || {};
            return CKEDITOR.tools.extend({id:"cancel", type:"button", label:a.lang.common.cancel,
      ...
      CKEDITOR.event.implementOn(CKEDITOR.dialog.prototype,
        true);
      var m = {resizable:CKEDITOR.DIALOG_RESIZE_BOTH, minWidth:600, minHeight:400, buttons:[CKEDITOR.dialog.okButton, CKEDITOR.dialog.cancelButton]}, p = function (a, b, c) {
      ...
      var u, v = {}, w, x = {}, y = function (a) {
        ...
        (x[c] || (x[c] = [])).push({uiElement:a, dialog:b, key:c, keyup:f || a.accessKeyUp, keydown:d || a.accessKeyDown})
      }, J = function (a) {
        for (var b in x) {
        ...
        CKEDITOR.ui.dialog = {uiElement:function (a, b, c, d, f, e, g) {
          if (!(arguments.length < 4)) {
            ...
            a.on("load", function () {
              ...
              if (b) {
                var c = q.type in{checkbox:1, ratio:1} && CKEDITOR.env.ie && CKEDITOR.env.version < 8 ? "cke_dialog_ui_focused" : "";
                b.on("focus", function () {
          ...
          if (!(arguments.length < 4)) {
            this._ || (this._ = {});
            var e = this._.children = b, g = f && f.widths || null, h = f && f.height || null, j, i = {role:"presentation"};
            f && f.align && (i.align = f.align);
            CKEDITOR.ui.dialog.uiElement.call(this, a, f || {type:"hbox"}, d, "table", {}, i, function () {
      ...
      (function () {
        ...
        CKEDITOR.dialog.validate = {functions:function () {
          ...
          return function () {
            ...
            for (e = 0; e < a.length; e++)if (typeof a[e] == "function")f.push(a[e]); else break;
    ...
    (function () {
      CKEDITOR.plugins.add("a11yhelp", {requires:"dialog", availableLangs:{en:1, cs:1, cy:1, da:1, de:1, el:1, eo:1, fa:1, fi:1, fr:1, gu:1, he:1, it:1, mk:1, nb:1, nl:1, no:1, "pt-br":1, ro:1, tr:1, ug:1, vi:1, "zh-cn":1}, init:function (a) {
        var b =
          this;
        a.addCommand("a11yHelp", {exec:function () {
    ...
    CKEDITOR.plugins.add("basicstyles", {init:function (a) {
      var b = 0, c = function (c, d, e, g) {
        ...
        a.ui.addButton && a.ui.addButton(c, {label:d, command:e,
    ...
    (function () {
      ...
      var d = {table:1, ul:1, ol:1, blockquote:1, div:1}, i = {}, f = {};
      CKEDITOR.tools.extend(i, d, {tr:1, p:1, div:1, li:1});
      CKEDITOR.tools.extend(f, i, {td:1});
        ...
        if (!a.blockless) {
          var b = function (b, c, d, f, e) {
            ...
            if (a.ui.addButton) {
              ...
              a.ui.addButton(b, {label:c, command:d, toolbar:"bidi," + e})
            }
          }, d = a.lang.bidi;
    ...
    (function () {
      var a = {exec:function (a) {
        ...
        if (d) {
          ...
          if (c == CKEDITOR.TRISTATE_OFF) {
            ...
            for (c = {table:1, tbody:1, tr:1, ol:1, ul:1}; c[g.getName()];)g = g.getParent();
      ...
      CKEDITOR.plugins.add("blockquote", {init:function (b) {
        if (!b.blockless) {
          b.addCommand("blockquote", a);
          b.ui.addButton && b.ui.addButton("Blockquote",
            {label:b.lang.blockquote.toolbar, command:"blockquote", toolbar:"blocks,10"})
        }
      }})
    })();
    "use strict";
    (function () {
      function a(a) {
        ...
        function m(b, c) {
          ...
          if (!d.getById("cke_pastebin")) {
            ...
            if (h) {
              ...
              k.setStyles({position:"absolute", top:d.getScrollPosition().y -
                p + 10 + "px", width:"1px", height:Math.max(1, d.getViewPaneSize().height - 20) + "px", overflow:"hidden", margin:0, padding:0})
            }
        ...
        (function () {
          function b(c, d, e, g, h) {
            ...
            a.addCommand(d, e);
            a.ui.addButton && a.ui.addButton(c, {label:j, command:d, toolbar:"clipboard," + g});
            a.addMenuItems && a.addMenuItem(d, {label:j, command:d, group:"clipboard", order:h})
          }
      ...
      function h() {
        ...
        }, td:l, th:l, $:function (a) {
          var f = a.name, p;
          if (i[f])return false;
          delete a.attributes;
          if (f == "br")return a;
          if (b[f])a.name = "p"; else if (c[f])delete a.name; else if (h[f]) {
    ...
    (function () {
      ...
      CKEDITOR.ui.button.prototype = {render:function (a, d) {
        var i = CKEDITOR.env, f = this._.id = CKEDITOR.tools.getNextId(), e = "", g = this.command, j;
        this._.editor = a;
        var k = {id:f, button:this, editor:a, focus:function () {
        ...
        i = {id:f, name:o, label:this.label, state:e, title:this.title, titleJs:i.gecko && i.version >= 10900 && !i.hc ? "" : (this.title || "").replace("'",
          ""), hasArrow:this.hasArrow ? "true" : "false", keydownFn:q, focusFn:l, clickFn:j, style:CKEDITOR.skin.getIconStyle(o, a.lang.dir == "rtl", this.icon, this.iconOffset), arrowHtml:this.hasArrow ? b.output() : ""};
        c.output(i, d);
    ...
    (function () {
      ...
      CKEDITOR.ui.panel.prototype = {render:function (h, d) {
        this.getHolderElement = function () {
          ...
          if (!a) {
            if (this.isFramed) {
              ...
              a.write(c.output(CKEDITOR.tools.extend({css:CKEDITOR.tools.buildStyleHtml(this.css),
                onload:"window.parent.CKEDITOR.tools.callFunction(" + b + ");"}, i)));
        ...
        var i = {id:this.id, langCode:h.langCode, dir:h.lang.dir, cls:this.className, frame:"", env:CKEDITOR.env.cssClass, "z-index":h.config.baseFloatZIndex + 1};
        if (this.isFramed)i.frame = b.output({id:this.id + "_frame", src:"javascript:void(document.open()," + (CKEDITOR.env.isCustomDomain() ? "document.domain='" + document.domain + "'," : "") + 'document.close())">'});
        var f = a.output(i);
        d && d.push(f);
        return f
    ...
    (function () {
      function a(a, h, d, i, f) {
        ...
        if (!e) {
          ...
          e.element.setStyles({display:"none", position:"absolute"})
        }
        return e
      }

      var b = {};
      CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({$:function (b, h, d, i) {
        d.forceIFrame = 1;
        var f = h.getDocument(), i = a(b, f, h, d, i || 0), e = i.element, g = e.getFirst();
        e.disableContextMenu();
        this.element = e;
        this._ = {editor:b, panel:i, parentElement:h, definition:d, document:f,
          iframe:g, children:[], dir:b.lang.dir};
        b.on("mode", function () {
          this.hide()
        }, this)
        ...
        if (q && (d == 1 || d == 4))l = l + b.$.offsetWidth; else if (!q && (d == 2 || d == 3))l = l + (b.$.offsetWidth - 1);
        if (d == 3 || d == 4)n = n + (b.$.offsetHeight - 1);
        this._.panel._.offsetParentId = b.getId();
        j.setStyles({top:n + "px", left:0, display:""});
        j.setOpacity(0);
        ...
        CKEDITOR.tools.setTimeout(function () {
          var a = CKEDITOR.tools.bind(function () {
            ...
            j.setStyles({top:n + "px", left:l + "px"});
            j.setOpacity(1)
          }, this);
    ...
    CKEDITOR.plugins.add("colorbutton", {requires:"panelbutton,floatpanel", init:function (a) {
      function b(b, d, g, h) {
        var k = CKEDITOR.tools.getNextId() + "_colorBox";
        a.ui.add(b, CKEDITOR.UI_PANELBUTTON, {label:g, title:g, modes:{wysiwyg:1}, editorFocus:1, toolbar:"colors," + h, panel:{css:CKEDITOR.skin.getPath("editor"), attributes:{role:"listbox", "aria-label":i.panelTitle}}, onBlock:function (b, f) {
          f.autoSize = true;
      ...
      function c(b, c, g) {
        var j = [], k = d.colorButton_colors.split(","), q = CKEDITOR.tools.addFunction(function (c, g) {
          if (c == "?") {
            ...
            b.hide();
            a.fire("saveSnapshot");
            a.removeStyle(new CKEDITOR.style(d["colorButton_" + g + "Style"], {color:"inherit"}));
            if (c) {
              ...
              a.applyStyle(new CKEDITOR.style(j, {color:c}))
            }
            a.fire("saveSnapshot")
          }
        });
    ...
    CKEDITOR.plugins.colordialog = {requires:"dialog", init:function (a) {
    ...
    (function () {
      ...
      CKEDITOR.menu = CKEDITOR.tools.createClass({$:function (a, b) {
        ...
        var c = CKEDITOR.tools.extend({}, b.panel, {css:[CKEDITOR.skin.getPath("editor")], level:this._.level - 1, block:{}}), e = c.block.attributes = c.attributes || {};
        !e.role && (e.role = "menu");
        this._.panelDefinition = c
      }, _:{onShow:function () {
        var a =
      ...
      CKEDITOR.menuItem = CKEDITOR.tools.createClass({$:function (a, b, c) {
        ...
        var e = typeof this.state ==
          ...
          this.editor.lang.dir == "rtl", this.icon, this.iconOffset), arrowHtml:g ? h.output({label:j}) : ""};
        c.output(a, f)
      }}})
    })();
    ...
    CKEDITOR.plugins.add("contextmenu", {requires:"menu", onLoad:function () {
      CKEDITOR.plugins.contextMenu = CKEDITOR.tools.createClass({base:CKEDITOR.menu, $:function (a) {
        this.base.call(this, a, {panel:{className:"cke_menu_panel",
          attributes:{"aria-label":a.lang.contextmenu.options}}})
      }, proto:{addTarget:function (a, b) {
        if (CKEDITOR.env.opera && !("oncontextmenu"in document.body)) {
          var c;
          a.on("mousedown", function (d) {
            d = d.data;
            if (d.$.button != 2)d.getKeystroke() == CKEDITOR.CTRL + 1 && a.fire("contextmenu", d); else if (!b || !(CKEDITOR.env.mac ? d.$.metaKey : d.$.ctrlKey)) {
              var f = d.getTarget();
              if (!c) {
                f = f.getDocument();
      ...
      a.addCommand("contextMenu", {exec:function () {
    ...
    (function () {
      CKEDITOR.plugins.add("div", {requires:"dialog", init:function (a) {
        if (!a.blockless) {
          var b = a.lang.div;
          a.addCommand("creatediv", new CKEDITOR.dialogCommand("creatediv", {contextSensitive:true, refresh:function (a, b) {
          ...
          a.addCommand("removediv", {exec:function (a) {
            function b(d) {
          ...
          a.ui.addButton && a.ui.addButton("CreateDiv", {label:b.toolbar, command:"creatediv", toolbar:"blocks,50"});
          if (a.addMenuItems) {
            a.addMenuItems({editdiv:{label:b.edit, command:"editdiv", group:"div", order:1}, removediv:{label:b.remove, command:"removediv", group:"div", order:5}});
            a.contextMenu && a.contextMenu.addListener(function (b) {
              return!b || b.isReadOnly() ? null : CKEDITOR.plugins.div.getSurroundDiv(a) ?
              {editdiv:CKEDITOR.TRISTATE_OFF, removediv:CKEDITOR.TRISTATE_OFF} : null
            })
          }
      ...
      CKEDITOR.plugins.div = {getSurroundDiv:function (a, b) {
        var c = a.elementPath(b);
        return a.elementPath(c.blockLimit).contains("div", 1)
      }}
    })();
    (function () {
      var a = {editorFocus:false, readOnly:1, exec:function (a) {
      ...
      CKEDITOR.plugins.add("elementspath", {init:function (c) {
        function i(a) {
          c.focus();
        ...
        c._.elementsPath = {idBase:j, filters:[]};
        ...
        c.on("selectionChange", function (a) {
          for (var f = c.editable(), i = a.data.selection.getStartElement(), a = [], m = c._.elementsPath.list = [], p = c._.elementsPath.filters; i;) {
            ...
            if (!s) {
              ...
              r = h.output({id:j + s, label:t, text:r, jsTitle:"javascript:void('" + r + "')", index:s, keyDownFn:q, clickFn:k});
              a.unshift(r)
            }
            if (i.equals(f))break;
            i = i.getParent()
    ...
    (function () {
      function a(a, b, c) {
        function d(c) {
          if ((i = j[c ? "getFirst" : "getLast"]()) && (!i.is || !i.isBlockBoundary()) && (k = b.root[c ? "getPrevious" : "getNext"](CKEDITOR.dom.walker.invisible(true))) && (!k.is || !k.isBlockBoundary({br:1})))a.document.createElement("br")[c ? "insertBefore" : "insertAfter"](i)
        }
      ...
      var g = {ol:1, ul:1}, j = CKEDITOR.dom.walker.whitespaces(), k = CKEDITOR.dom.walker.bookmark(), q = function (a) {
        return!(j(a) || k(a))
      }, l = CKEDITOR.dom.walker.bogus();
      CKEDITOR.plugins.list = {listToArray:function (a, b, c, d, f) {
        ...
        for (var e = 0, h = a.getChildCount(); e < h; e++) {
          ...
          if (j.$.nodeName.toLowerCase() ==
            "li") {
            var i = {parent:a, indent:d, element:j, contents:[]};
            if (f)i.grandparent = f; else {
        ...
        return c
      }, arrayToList:function (a, b, c, d, f) {
        c || (c = 0);
      ...
      b.prototype = {exec:function (b) {
        ...
        for (var c = d.createBookmarks(true), e = [], i = {}, f = f.createIterator(), k = 0; (j = f.getNextRange()) && ++k;) {
          ...
          for (j.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; p = j.getNextParagraph();)if (!p.getCustomData("list_block")) {
            ...
            if (!o) {
              o = l;
              if (o.getCustomData("list_group_object_" + k))o.getCustomData("list_group_object_" + k).contents.push(p); else {
                m = {root:o, contents:[p]};
          ...
          if (this.state == CKEDITOR.TRISTATE_OFF)if (g[m.root.getName()]) {
            ...
            for (var r = f.root.getDocument(), t = void 0, I = void 0, j = 0; j < l.length; j++) {
              ...
              if (!t.is(this.type)) {
                ...
                t.copyAttributes(I, {start:1, type:1});
            ...
            if (!(k.length < 1)) {
              ...
              for (t = j = void 0; k.length;) {
                ...
                if (j.is("pre") || n.test(j.getName()))j.appendTo(t); else {
                  j.copyAttributes(t);
                  if (m && j.getDirection()) {
      ...
      CKEDITOR.plugins.add("list", {init:function (a) {
        if (!a.blockless) {
          ...
          if (a.ui.addButton) {
            a.ui.addButton("NumberedList", {label:a.lang.list.numberedlist, command:"numberedlist", toolbar:"list,10"});
            a.ui.addButton("BulletedList", {label:a.lang.list.bulletedlist, command:"bulletedlist", toolbar:"list,20"})
          }
          a.on("key", function (b) {
    ...
    (function () {
      ...
      var h = {ol:1, ul:1}, d = CKEDITOR.dom.walker.whitespaces(true), i = CKEDITOR.dom.walker.bookmark(false, true);
      a.prototype = {context:"p", refresh:function (a, c) {
        var d = c && c.contains(h), j = c.block || c.blockLimit;
        if (d)this.setState(CKEDITOR.TRISTATE_OFF); else if (!this.useIndentClasses && this.name == "indent")this.setState(CKEDITOR.TRISTATE_OFF); else if (j)if (this.useIndentClasses) {
      ...
      CKEDITOR.plugins.add("indent", {requires:"list", onLoad:function () {
        ...
        if (!b.blockless) {
          ...
          if (b.ui.addButton) {
            b.ui.addButton("Indent", {label:b.lang.indent.indent,
              command:"indent", toolbar:"indent,20"});
            b.ui.addButton("Outdent", {label:b.lang.indent.outdent, command:"outdent", toolbar:"indent,10"})
          }
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("enterkey", {requires:"indent", init:function (b) {
        b.addCommand("enter", {modes:{wysiwyg:1}, editorFocus:false, exec:function (b) {
          a(b)
        }});
        b.addCommand("shiftEnter", {modes:{wysiwyg:1}, editorFocus:false, exec:function (b) {
      ...
      CKEDITOR.plugins.enterkey = {enterBlock:function (a, d, f, q) {
        if (f = f || b(a)) {
          ...
          if (p) {
            ...
            if (!n && !o) {
              ...
              if (r)q && !r.is("li") && r.renameNode(m); else if (s && s.is("li"))r = s; else {
                r = l.createElement(m);
        ...
        if (d = d || b(a)) {
          ...
          if (!h && o == "li")f(a, c, d, h); else {
            if (!h && n && e.test(o))if (n = m.getDirection()) {
              ...
              d.deleteContents();
              d.insertNode(m);
              if (CKEDITOR.env.ie)d.setStartAt(m, CKEDITOR.POSITION_AFTER_END); else {
                ...
                n = null;
                if (CKEDITOR.env.gecko)n = i.createElement("br"); else {
    ...
    (function () {
      function a(a, c) {
        var h = {}, d = [], i = {nbsp:" ", shy:"­", gt:">", lt:"<", amp:"&", apos:"'", quot:'"'}, a = a.replace(/\b(nbsp|shy|gt|lt|amp|apos|quot)(?:,|$)/g, function (a, b) {
          var f =
            c ? "&" + b + ";" : i[b];
          h[f] = c ? i[b] : "&" + b + ";";
          d.push(f);
      ...
      CKEDITOR.plugins.add("entities", {afterInit:function (b) {
        var c = b.config;
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {popup:function (a, b, c, h) {
      b = b || "80%";
      c = c || "70%";
    ...
    (function () {
      ...
      function i(a, f, e, q) {
        ...
        for (n in q) {
          ...
          if (l.filebrowser) {
            if (typeof l.filebrowser == "string")l.filebrowser = {action:l.type == "fileButton" ? "QuickUpload" : "Browse", target:l.filebrowser};
    ...
    CKEDITOR.plugins.add("find",
      {requires:"dialog", init:function (a) {
        ...
        if (a.ui.addButton) {
          a.ui.addButton("Find", {label:a.lang.find.find, command:"find", toolbar:"find,10"});
    ...
    (function () {
      ...
      var b = CKEDITOR.htmlParser.cssStyle, c = CKEDITOR.tools.cssLength, h = /^((?:\d*(?:\.\d+))|(?:\d+))(.*)?$/i, d = {elements:{$:function (c) {
        var d = c.attributes;
        ...
        return d
      }}}, i = CKEDITOR.plugins.add("fakeobjects", {afterInit:function (a) {
        (a = (a = a.dataProcessor) && a.htmlFilter) && a.addRules(d)
      }});
      CKEDITOR.editor.prototype.createFakeElement = function (a, d, g, h) {
        var k = this.lang.fakeobjects, k = k[g] || k.unknown, d = {"class":d, "data-cke-realelement":encodeURIComponent(a.getOuterHtml()), "data-cke-real-node-type":a.type, alt:k, title:k,
        ...
        return this.document.createElement("img", {attributes:d})
      };
      CKEDITOR.editor.prototype.createFakeParserElement = function (a, d, g, h) {
        ...
        a.writeHtml(q);
        q = q.getHtml();
        d = {"class":d, "data-cke-realelement":encodeURIComponent(q), "data-cke-real-node-type":a.type, alt:i, title:i, align:a.attributes.align || ""};
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("flash", {requires:"dialog,fakeobjects", onLoad:function () {
        ...
        afterInit:function (c) {
          ...
          (d = d && d.dataFilter) && d.addRules({elements:{"cke:object":function (d) {
            var f = d.attributes;
    ...
    (function () {
      ...
      function b(b) {
        ...
        }, e = CKEDITOR.document.getBody(), n = {id:b.id, name:b.name, langDir:b.lang.dir, langCode:b.langCode, "z-index":b.config.baseFloatZIndex - 1}, o = b.fire("uiSpace", {space:"top", html:""}).html;
        if (o) {
          var m = e.append(CKEDITOR.dom.element.createFromHtml(c.output(CKEDITOR.tools.extend({topId:b.ui.spaceId("top"), content:o, style:"display:none;"}, n))));
          m.unselectable();
    ...
    CKEDITOR.plugins.add("listblock", {requires:"panel", onLoad:function () {
      ...
      CKEDITOR.ui.listBlock = CKEDITOR.tools.createClass({base:CKEDITOR.ui.panel.block, $:function (a, b) {
        ...
        this._.items[a] = f;
        a = {id:f, val:a, onclick:CKEDITOR.env.ie ? 'onclick="return false;" onmouseup' : "onclick", clickFn:this._.getClick(), title:i || a, text:c || a};
        this._.pendingList.push(b.output(a))
      }, startGroup:function (a) {
        this._.close();
        var b = CKEDITOR.tools.getNextId();
        this._.groups[a] = b;
        this._.pendingHtml.push(c.output({id:b, label:a}))
      }, commit:function () {
        this._.close();
    ...
    CKEDITOR.plugins.add("richcombo", {requires:"floatpanel,listblock,button", beforeInit:function (a) {
    ...
    (function () {
      ...
      CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({$:function (a) {
        ...
        this._ = {panelDefinition:a, items:{}, state:CKEDITOR.TRISTATE_OFF}
        ...
        }, this), g = {id:f, combo:this, focus:function () {
        ...
        g.keyDownFn = j;
        i = {id:f, name:this.name || this.command, label:this.label, title:this.title, titleJs:i.gecko && i.version >= 10900 && !i.hc ? "" : (this.title || "").replace("'",
          ""), keydownFn:j, focusFn:k, clickFn:e};
        b.output(i, h);
        if (this.onRender)this.onRender();
        return g
    ...
    (function () {
      function a(a, c, h, d, i, f, e, g) {
        ...
        a.ui.addRichCombo(c, {label:d.label, title:d.panelTitle, toolbar:"styles," + g, panel:{css:[CKEDITOR.skin.getPath("editor")].concat(j.contentsCss), multiSelect:false, attributes:{"aria-label":d.panelTitle}}, init:function () {
      ...
      CKEDITOR.plugins.add("font", {requires:"richcombo", init:function (b) {
        var c = b.config;
    ...
    CKEDITOR.plugins.add("format", {requires:"richcombo",
      init:function (a) {
        if (!a.blockless) {
          ...
          a.ui.addRichCombo("Format", {label:c.label, title:c.panelTitle, toolbar:"styles,20", panel:{css:[CKEDITOR.skin.getPath("editor")].concat(b.contentsCss), multiSelect:false, attributes:{"aria-label":c.panelTitle}}, init:function () {
    ...
    CKEDITOR.plugins.add("forms", {requires:"dialog,fakeobjects", onLoad:function () {
      ...
      var b = a.lang, c = 0, h = function (d, e, g) {
        ...
        a.ui.addButton && a.ui.addButton(d, {label:b.common[d.charAt(0).toLowerCase() + d.slice(1)], command:e, toolbar:"forms," + (c = c + 10)});
      ...
      if (a.addMenuItems) {
        h = {checkbox:{label:b.forms.checkboxAndRadio.checkboxTitle, command:"checkbox", group:"checkbox"}, radio:{label:b.forms.checkboxAndRadio.radioTitle, command:"radio", group:"radio"}, textfield:{label:b.forms.textfield.title, command:"textfield", group:"textfield"}, hiddenfield:{label:b.forms.hidden.title, command:"hiddenfield",
          group:"hiddenfield"}, imagebutton:{label:b.image.titleButton, command:"imagebutton", group:"imagebutton"}, button:{label:b.forms.button.title, command:"button", group:"button"}, select:{label:b.forms.select.title, command:"select", group:"select"}, textarea:{label:b.forms.textarea.title, command:"textarea", group:"textarea"}};
        !a.blockless && (h.form = {label:b.forms.form.menu, command:"form", group:"form"});
        a.addMenuItems(h)
      }
      if (a.contextMenu) {
        !a.blockless && a.contextMenu.addListener(function (a, b, c) {
          if ((a = c.contains("form",
            1)) && !a.isReadOnly())return{form:CKEDITOR.TRISTATE_OFF}
        });
        a.contextMenu.addListener(function (a) {
          if (a && !a.isReadOnly()) {
            ...
            if (b == "input")switch (a.getAttribute("type")) {
              ...
              case "image":
                return i ? {imagebutton:CKEDITOR.TRISTATE_OFF} :
                  null;
              default:
      ...
      a.on("doubleclick", function (b) {
        ...
        if (!a.blockless && c.is("form"))b.data.dialog = "form"; else if (c.is("select"))b.data.dialog = "select"; else if (c.is("textarea"))b.data.dialog = "textarea"; else if (c.is("img") && c.data("cke-real-element-type") == "hiddenfield")b.data.dialog = "hiddenfield"; else if (c.is("input"))switch (c.getAttribute("type")) {
          case "button":
          case "submit":
          case "reset":
            b.data.dialog =
      ...
      CKEDITOR.env.ie && c && c.addRules({elements:{input:function (a) {
    ...
    (function () {
      var a = {canUndo:false, exec:function (a) {
        var c = a.document.createElement("hr");
        a.insertElement(c)
      }};
      CKEDITOR.plugins.add("horizontalrule", {init:function (b) {
        if (!b.blockless) {
          b.addCommand("horizontalrule", a);
          b.ui.addButton && b.ui.addButton("HorizontalRule", {label:b.lang.horizontalrule.toolbar, command:"horizontalrule", toolbar:"insert,40"})
        }
      }})
    })();
    CKEDITOR.plugins.add("htmlwriter", {init:function (a) {
    ...
    CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({base:CKEDITOR.htmlParser.basicWriter, $:function () {
      ...
      for (b in CKEDITOR.tools.extend({}, a.$nonBodyContent, a.$block, a.$listItem, a.$tableContent))this.setRules(b, {indent:!a[b]["#"],
        breakBeforeOpen:1, breakBeforeClose:!a[b]["#"], breakAfterClose:1, needsSpace:b in a.$block && !(b in{li:1, dt:1, dd:1})});
      ...
      if (this._.indent)this.indentation(); else if (b && b.breakBeforeOpen) {
        this.lineBreak();
        this.indentation()
      }
      this._.output.push("<", a);
      ...
      if (this._.indent)this.indentation(); else if (b && b.breakBeforeClose) {
        this.lineBreak();
        this.indentation()
      }
      this._.output.push("</", a, ">");
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("image", {requires:"dialog",
        init:function (b) {
          ...
          b.contextMenu && b.contextMenu.addListener(function (h) {
            if (a(b,
              h))return{image:CKEDITOR.TRISTATE_OFF}
          })
        }, afterInit:function (c) {
          function h(d) {
    ...
    CKEDITOR.plugins.add("link", {requires:"dialog,fakeobjects",
      onLoad:function () {
        ...
        if (a.ui.addButton) {
          a.ui.addButton("Link", {label:a.lang.link.toolbar, command:"link",
            toolbar:"links,10"});
          a.ui.addButton("Unlink", {label:a.lang.link.unlink, command:"unlink", toolbar:"links,20"});
          a.ui.addButton("Anchor", {label:a.lang.link.anchor.toolbar, command:"anchor", toolbar:"links,30"})
        }
        ...
        c && c.addRules({elements:{a:function (b) {
          var c = b.attributes;
        ...
        CKEDITOR.plugins.link.emptyAnchorFix &&
          b && b.addRules({elements:{a:function (a) {
          delete a.attributes.contenteditable
        }}});
    ...
    CKEDITOR.plugins.link = {getSelectedLink:function (a) {
      ...
      CKEDITOR.env.webkit, synAnchorSelector:CKEDITOR.env.ie, emptyAnchorFix:CKEDITOR.env.ie && 8 > CKEDITOR.env.version, tryRestoreFakeAnchor:function (a, b) {
    ...
    CKEDITOR.removeAnchorCommand.prototype = {exec:function (a) {
      ...
      if (b && (h = b.getSelectedElement()) && (CKEDITOR.plugins.link.fakeAnchor && !h.getChildCount() ? CKEDITOR.plugins.link.tryRestoreFakeAnchor(a,
        h) : h.is("a")))h.remove(1); else if (h = CKEDITOR.plugins.link.getSelectedLink(a))if (h.hasAttribute("href")) {
      ...
      CKEDITOR.plugins.liststyle = {requires:"dialog,contextmenu", init:function (a) {
        ...
        a.contextMenu.addListener(function (a) {
          ...
          for (; a;) {
            var c =
              a.getName();
            if (c == "ol")return{numberedlist:CKEDITOR.TRISTATE_OFF};
            if (c == "ul")return{bulletedlist:CKEDITOR.TRISTATE_OFF};
            a = a.getParent()
          }
          return null
        })
    ...
    (function () {
      ...
      function f(a) {
        ...
        C(c, {attach:function () {
          ...
          "border-width:8px 0 0 8px;top:-8px", "border-width:0 0 8px 8px;top:0px"]}), C(O(I, b), {base:L + "right:0px;border-right-color:" + a.boxColor + ";", looks:["border-width:8px 8px 8px 0;top:-8px", "border-width:8px 8px 0 0;top:-8px", "border-width:0 8px 8px 0;top:0px"]})], detach:function () {
          ...
          if (f && e)j.top = f.size.margin.bottom === e.size.margin.top ? 0 | f.size.bottom + f.size.margin.bottom / 2 :
            f.size.margin.bottom < e.size.margin.top ? f.size.bottom + f.size.margin.bottom : f.size.bottom + f.size.margin.bottom - e.size.margin.top; else if (f) {
      ...
      function s(a, b, c, d) {
        ...
        return C({border:g, padding:j, margin:h, ignoreScroll:c}, i, true)
      }
      ...
      function r(a, b, c) {
        ...
        return C(b.size, s(a, b, c), {date:+new Date}, true)
      }
      ...
      function u(a, b) {
        ...
        if (b || !(c && c.date > new Date - G)) {
          ...
          C(a.view, {scroll:{x:c.x, y:c.y, width:a.doc.$.documentElement.scrollWidth - d.width, height:a.doc.$.documentElement.scrollHeight - d.height}, pane:{width:d.width, height:d.height, bottom:d.height + c.y}, date:+new Date}, true)
        }
      }
      ...
      function v(b, c, d, f) {
        for (var e = f, g = f, h = 0, j = false, i = false, k = b.view.pane.height, b = b.mouse; b.y + h < k && b.y - h > 0;) {
          j || (j = !c(e, f));
          i || (i = !c(g, f));
          !j && b.y - h > 0 && (e = d({x:b.x, y:b.y - h}));
          !i && b.y + h < k && (g = d({x:b.x, y:b.y + h}));
          if (j && i)break;
          h = h + 2
        }
        return new a(e,
      ...
      CKEDITOR.plugins.add("magicline", {init:function (e) {
        var h = e.config, n = h.magicline_triggerOffset || 30, l = {editor:e, triggerOffset:n, holdDistance:0 | n * (h.magicline_holdDistance || 0.5), boxColor:h.magicline_color || "#ff0000", rtl:h.contentsLangDirection == "rtl", triggers:h.magicline_everywhere ? CKEDITOR.dtd.$block : {table:1, hr:1, div:1, ul:1, ol:1, dl:1}}, v, y, D, A;
        l.isRelevant = function (a) {
          return j(a) && !g(l, a) && !k(a)
        };
        e.on("contentDom", function () {
          var h = e.editable(), k = e.document, n = e.window;
          C(l, {editable:h, doc:k,
            win:n}, true);
          if (!h.is(CKEDITOR.dtd.$inline)) {
            i(l) && !q(h) && h.setStyles({position:"relative", top:null, left:null});
            f.call(this, l);
            u(l);
              ...
              if (!(e.mode != "wysiwyg" || A)) {
                ...
                A = setTimeout(function () {
                  ...
                  if (D && !l.hiddenMode && e.focusManager.hasFocus && !l.line.mouseNear() && (l.element = b(l, true))) {
                    ...
                    if ((l.trigger = c || o(l) || m(l)) && p(l))l.line.attach().place(); else {
                      l.trigger = null;
                      l.line.detach()
                    }
                    D = false
            ...
            this.backdoor = {boxTrigger:a, isHtml:j, isLine:g, getAscendantTrigger:c, getNonEmptyNeighbour:d, getSize:s, triggerFilter:p, that:l, updateSize:r, updateWindowSize:u}
          }
        }, this)
      }});
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("maximize", {init:function (a) {
        function b() {
          ...
          o && o.setStyles({width:c.width + "px",
            height:c.height + "px"});
        ...
        if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
          ...
          a.addCommand("maximize", {modes:{wysiwyg:!CKEDITOR.env.iOS, source:!CKEDITOR.env.iOS}, readOnly:1, editorFocus:false, exec:function () {
            ...
            if (this.state == CKEDITOR.TRISTATE_OFF) {
              ...
              p.$.offsetLeft;
              p.setStyles({"z-index":a.config.baseFloatZIndex - 1, left:"0px", top:"0px"});
              o = i(p);
              p.addClass("cke_maximized");
              b();
              s = p.getDocumentPosition();
              p.setStyles({left:-1 * s.x + "px", top:-1 * s.y + "px"});
          ...
          a.ui.addButton && a.ui.addButton("Maximize", {label:g.maximize.maximize, command:"maximize", toolbar:"tools,10"});
          a.on("mode", function () {
    ...
    CKEDITOR.plugins.add("newpage", {init:function (a) {
      a.addCommand("newpage", {modes:{wysiwyg:1, source:1}, exec:function (a) {
        var c = this;
        a.setData(a.config.newpage_html ||
          "", function () {
          a.focus();
          setTimeout(function () {
            a.fire("afterCommandExec", {name:"newpage", command:c});
            a.selectionChange()
          }, 200)
        })
      }, async:true});
    ...
    CKEDITOR.plugins.add("pagebreak", {onLoad:function () {
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("pastefromword", {requires:"clipboard", init:function (c) {
        var h = 0, d = this.path;
        c.addCommand("pastefromword", {canUndo:false, async:true, exec:function (a) {
          var c = this;
          h = 1;
          a.on("beforePaste", b);
          a.getClipboardData({title:a.lang.pastefromword.title},
            function (b) {
              b && a.fire("paste", {type:"html", dataValue:b.dataValue});
        ...
        c.on("paste", function (b) {
          ...
          if (e && (h || /(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(e))) {
            var g = a(d, function () {
              if (g)c.fire("paste",
                f); else if (!c.config.pasteFromWordPromptCleanup || h || confirm(c.lang.pastefromword.confirmCleanup))f.dataValue = CKEDITOR.cleanWord(e, c)
            });
            g && b.cancel()
          }
        }, null, null, 3)
    ...
    (function () {
      var a = {canUndo:false, async:true, exec:function (b) {
        b.getClipboardData({title:b.lang.pastetext.title}, function (c) {
          c && b.fire("paste", {type:"text", dataValue:c.dataValue});
          b.fire("afterCommandExec", {name:"pastetext", command:a, returnValue:!!c})
        })
      }};
      CKEDITOR.plugins.add("pastetext", {requires:"clipboard", init:function (b) {
    ...
    (function () {
      var a, b = {modes:{wysiwyg:1, source:1}, canUndo:false, readOnly:1, exec:function (b) {
        var h = b.config, d = h.baseHref ? '<base href="' + h.baseHref + '"/>' : "", i = CKEDITOR.env.isCustomDomain();
        if (h.fullPage)b =
          b.getData().replace(/<head>/, "$&" + d).replace(/[^>]*(?=<\/title>)/, "$& &mdash; " + b.lang.preview.preview); else {
    ...
    CKEDITOR.plugins.add("print", {init:function (a) {
      if (a.elementMode !=
        ...
        a.ui.addButton && a.ui.addButton("Print", {label:a.lang.print.toolbar, command:"print", toolbar:"document,50"})
      }
    }});
    ...
    CKEDITOR.plugins.removeformat = {commands:{removeformat:{exec:function (a) {
        ...
        if (j) {
          ...
          for (g = g.getNextSourceNode(true, CKEDITOR.NODE_ELEMENT); g;) {
            ...
            if (!(g.getName() == "img" && g.data("cke-realelement")) &&
              h(a, g))if (b.test(g.getName()))g.remove(1); else {
      ...
      for (var c = a._.removeFormat.filters, h = 0; h < c.length; h++)if (c[h](b) === false)return false;
      return true
    }};
    ...
    CKEDITOR.plugins.add("resize", {init:function (a) {
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("save", {init:function (b) {
        if (b.elementMode == CKEDITOR.ELEMENT_MODE_REPLACE) {
          b.addCommand("save", a).modes = {wysiwyg:!!b.element.$.form};
          b.ui.addButton && b.ui.addButton("Save", {label:b.lang.save.toolbar, command:"save", toolbar:"document,10"})
        }
      }})
    })();
    CKEDITOR.plugins.add("menubutton", {requires:"button,menu", onLoad:function () {
        ...
        if (c.state !== CKEDITOR.TRISTATE_DISABLED) {
          ...
          if (!h) {
            h = c.menu = new CKEDITOR.menu(a,
              {panel:{className:"cke_menu_panel", attributes:{"aria-label":a.lang.common.options}}});
      ...
      CKEDITOR.ui.menuButton = CKEDITOR.tools.createClass({base:CKEDITOR.ui.button, $:function (b) {
        delete b.panel;
        this.base(b);
        this.hasArrow =
          true;
    ...
    (function () {
      ...
      var b = "", c = function () {
        var a = this, c = function () {
          ...
          if (typeof b == "object")for (var d in b)c[d] = b[d];
        ...
        (d = d && d.htmlFilter) && d.addRules({elements:{span:function (a) {
      ...
      CKEDITOR.plugins.scayt = {engineLoaded:false, instances:{}, controlInfo:{}, setControlInfo:function (a, b) {
        ...
        if (window.scayt == void 0) {
          CKEDITOR._djScaytConfig = {baseUrl:d, addOnLoad:[function () {
            CKEDITOR.fireOnce("scaytReady")
          }], isDebug:false};
          CKEDITOR.document.getHead().append(CKEDITOR.document.createElement("script", {attributes:{type:"text/javascript", async:"true", src:b}}))
      ...
      var h = CKEDITOR.plugins.scayt, d = function (a, b, c, d, h, i, l) {
        a.addCommand(d, h);
        a.addMenuItem(d, {label:c, command:d, group:i, order:l})
      }, i = {preserveState:true, editorFocus:false, canUndo:false, exec:function (a) {
        if (h.isScaytReady(a)) {
      ...
      CKEDITOR.plugins.add("scayt", {requires:"menubutton,dialog", beforeInit:function (a) {
        ...
        var e = c.dataProcessor && c.dataProcessor.dataFilter, g = {elements:{span:function (a) {
          var b =
            a.attributes;
        ...
        g.scaytToggle = {label:l.enable, command:"scaytcheck", group:"scaytButton"};
        if (e[0] == 1)g.scaytOptions = {label:l.options, group:"scaytButton",
          onClick:function () {
            b = "options";
            c.openDialog("scaytcheck")
          }};
        if (e[1] == 1)g.scaytLangs = {label:l.langs, group:"scaytButton", onClick:function () {
          b = "langs";
          c.openDialog("scaytcheck")
        }};
        if (e[2] == 1)g.scaytDict = {label:l.dictionariesTab, group:"scaytButton", onClick:function () {
          b = "dictionaries";
          c.openDialog("scaytcheck")
        }};
        g.scaytAbout = {label:c.lang.scayt.about, group:"scaytButton", onClick:function () {
          b = "about";
          c.openDialog("scaytcheck")
        }};
        c.addMenuItems(g);
        c.ui.add("Scayt", CKEDITOR.UI_MENUBUTTON, {label:l.title, title:CKEDITOR.env.opera ?
          l.opera_title : l.title, modes:{wysiwyg:1}, toolbar:"spellchecker,20", onRender:function () {
          q.on("state", function () {
          ...
          var b = h.getUiTabs(c);
          return{scaytToggle:CKEDITOR.TRISTATE_OFF, scaytOptions:a && b[0] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED, scaytLangs:a && b[1] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED, scaytDict:a && b[2] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
        ...
        c.contextMenu && c.addMenuItems && c.contextMenu.addListener(function (b, e) {
          ...
          if (r) {
            c.addMenuItem("scayt_moresuggest", {label:l.moreSuggestions, group:"scayt_moresuggest", order:10, getItems:function () {
              return j
            }});
            k.scayt_moresuggest = CKEDITOR.TRISTATE_OFF
          }
          if (a("all", v) || a("ignore", v)) {
            d(c, "ignore", l.ignore, "scayt_ignore", {exec:function () {
              g.ignore(i)
            }}, "scayt_control", 1);
            k.scayt_ignore = CKEDITOR.TRISTATE_OFF
          }
          if (a("all", v) || a("ignoreall", v)) {
            d(c, "ignore_all", l.ignoreAll, "scayt_ignore_all", {exec:function () {
              g.ignoreAll(i)
            }}, "scayt_control", 2);
          ...
          if (a("all",
            v) || a("add", v)) {
            d(c, "add_word", l.addWord, "scayt_add_word", {exec:function () {
    ...
    (function () {
      CKEDITOR.plugins.add("selectall", {init:function (a) {
        a.addCommand("selectAll", {modes:{wysiwyg:1, source:1}, exec:function (a) {
          var c = a.editable();
          if (c.is("textarea")) {
            a = c.$;
            if (CKEDITOR.env.ie)a.createTextRange().execCommand("SelectAll"); else {
              a.selectionStart =
                0;
            ...
            if (c.is("body"))a.document.$.execCommand("SelectAll", false, null); else {
              var h = a.createRange();
    ...
    (function () {
      var a = {readOnly:1, preserveState:true, editorFocus:false, exec:function (a) {
        this.toggleState();
        this.refresh(a)
      }, refresh:function (a) {
        if (a.document) {
      ...
      CKEDITOR.plugins.add("showblocks", {onLoad:function () {
        ...
        if (!b.blockless) {
          ...
          b.ui.addButton && b.ui.addButton("ShowBlocks", {label:b.lang.showblocks.toolbar, command:"showblocks", toolbar:"tools,20"});
          b.on("mode", function () {
    ...
    (function () {
      var a = {preserveState:true, editorFocus:false, readOnly:1, exec:function (a) {
        this.toggleState();
        this.refresh(a)
      }, refresh:function (a) {
        if (a.document) {
      ...
      CKEDITOR.plugins.add("showborders", {modes:{wysiwyg:1}, onLoad:function () {
        ...
        c && c.addRules({elements:{table:function (a) {
    ...
    (function () {
        ...
        if (c.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
          ...
          c.addMode("source",
            function (d) {
              ...
              h.setStyles(CKEDITOR.tools.extend({width:CKEDITOR.env.ie7Compat ? "99%" : "100%", height:"100%", resize:"none", outline:"none", "text-align":"left"}, CKEDITOR.tools.cssVendorPrefix("tab-size", c.config.sourceAreaTabSize || 4)));
              var f = [c.lang.editor, c.name].join();
              h.setAttributes({dir:"ltr", tabIndex:CKEDITOR.env.webkit ? -1 : c.tabIndex, role:"textbox", "aria-label":f});
      ...
      var b = CKEDITOR.tools.createClass({base:CKEDITOR.editable, proto:{setData:function (a) {
        this.setValue(a);
        this.editor.fire("dataReady")
      }, getData:function () {
        return this.getValue()
    ...
    CKEDITOR.plugins.sourcearea = {commands:{source:{modes:{wysiwyg:1, source:1},
    ...
    CKEDITOR.plugins.add("specialchar", {availableLangs:{cs:1, cy:1, de:1, en:1, eo:1, et:1, fa:1, fi:1, fr:1, hr:1, it:1, nb:1, nl:1, no:1, tr:1, ug:1, "zh-cn":1}, requires:"dialog", init:function (a) {
      var b = this;
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("stylescombo", {requires:"richcombo", init:function (b) {
        ...
        var h = b.config, d = b.lang.stylescombo,
          i = {}, f = [], e;
        b.ui.addRichCombo("Styles", {label:d.label, title:d.panelTitle, toolbar:"styles,10", panel:{css:[CKEDITOR.skin.getPath("editor")].concat(h.contentsCss), multiSelect:true, attributes:{"aria-label":d.panelTitle}}, init:function () {
          e = this;
          c(function () {
            var a, b, c, h, i, n;
            i = 0;
          ...
          for (var e in i) {
            var f = i[e], h = f.type;
            if (h == CKEDITOR.STYLE_BLOCK && !a.isContextFor(f.element))this.hideItem(e); else {
              if (f.checkActive(a))this.mark(e); else if (h == CKEDITOR.STYLE_OBJECT && !f.checkApplicable(a)) {
                this.hideItem(e);
                c[h]--
              }
              c[h]++
    ...
    (function () {
      ...
      var b = {editorFocus:false, modes:{wysiwyg:1, source:1}}, c = {exec:function (a) {
        a.container.focusNext(true, a.tabIndex)
      }}, h = {exec:function (a) {
        a.container.focusPrevious(true, a.tabIndex)
      }};
      CKEDITOR.plugins.add("tab", {init:function (d) {
    ...
    CKEDITOR.plugins.add("table", {requires:"dialog",
      init:function (a) {
        ...
        if (!a.blockless) {
          ...
          a.addCommand("tableDelete", b({exec:function (a) {
          ...
          a.addMenuItems && a.addMenuItems({table:{label:c.menu, command:"tableProperties", group:"table", order:5}, tabledelete:{label:c.deleteTable,
    ...
    (function () {
      ...
      function f(b) {
        if (b instanceof CKEDITOR.dom.selection) {
          ...
          a:{
            ...
            for (g = 0; i = b[g++];)if ((j = i.getPrevious()) && !j.getCustomData("delete_cell") || (j = i.getNext()) && !j.getCustomData("delete_cell")) {
        ...
        for (var c = b.getDocument(), J = l, z = y = 0, B = !d && new CKEDITOR.dom.documentFragment(c), F = 0, c = 0; c < e.length; c++) {
          ...
          if (!d) {
            ...
            if (h.getChildren().count()) {
              if (E != J && A && (!A.isBlockBoundary || !A.isBlockBoundary({br:1})))(J = B.getLast(CKEDITOR.dom.walker.whitespaces(true))) && (!J.is || !J.is("br")) && B.append("br");
              h.moveChildren(B)
            }
      ...
      var l = /^(?:td|th)$/;
      CKEDITOR.plugins.tabletools = {requires:"table,dialog,contextmenu", init:function (g) {
        function h(a) {
        ...
        g.addCommand("rowDelete", h({exec:function (a) {
          a = a.getSelection();
          e(c(a))
        }}));
        g.addCommand("rowInsertBefore", h({exec:function (a) {
          a = a.getSelection();
          b(a, true)
        }}));
        g.addCommand("rowInsertAfter", h({exec:function (a) {
          a =
            a.getSelection();
          b(a)
        }}));
        g.addCommand("columnDelete", h({exec:function (b) {
        ...
        g.addCommand("columnInsertBefore", h({exec:function (a) {
          a = a.getSelection();
          d(a, true)
        }}));
        g.addCommand("columnInsertAfter", h({exec:function (a) {
          a = a.getSelection();
          d(a)
        }}));
        g.addCommand("cellDelete", h({exec:function (a) {
          a = a.getSelection();
          f(a)
        }}));
        g.addCommand("cellMerge", h({exec:function (a) {
          e(j(a.getSelection()), true)
        }}));
        g.addCommand("cellMergeRight", h({exec:function (a) {
          e(j(a.getSelection(),
            "right"), true)
        }}));
        g.addCommand("cellMergeDown", h({exec:function (a) {
          e(j(a.getSelection(), "down"), true)
        }}));
        g.addCommand("cellVerticalSplit", h({exec:function (a) {
          e(k(a.getSelection()))
        }}));
        g.addCommand("cellHorizontalSplit", h({exec:function (a) {
          e(q(a.getSelection()))
        }}));
        g.addCommand("cellInsertBefore", h({exec:function (a) {
          a = a.getSelection();
          i(a, true)
        }}));
        g.addCommand("cellInsertAfter", h({exec:function (a) {
          a = a.getSelection();
          i(a)
        }}));
        g.addMenuItems && g.addMenuItems({tablecell:{label:l.cell.menu, group:"tablecell",
          order:1, getItems:function () {
            ...
            return{tablecell_insertBefore:CKEDITOR.TRISTATE_OFF, tablecell_insertAfter:CKEDITOR.TRISTATE_OFF, tablecell_delete:CKEDITOR.TRISTATE_OFF, tablecell_merge:j(b, null, true) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED, tablecell_merge_right:j(b, "right", true) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED, tablecell_merge_down:j(b, "down", true) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED, tablecell_split_vertical:k(b, true) ? CKEDITOR.TRISTATE_OFF :
              CKEDITOR.TRISTATE_DISABLED, tablecell_split_horizontal:q(b, true) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED, tablecell_properties:c.length > 0 ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED}
          }}, tablecell_insertBefore:{label:l.cell.insertBefore, group:"tablecell", command:"cellInsertBefore", order:5}, tablecell_insertAfter:{label:l.cell.insertAfter, group:"tablecell", command:"cellInsertAfter", order:10}, tablecell_delete:{label:l.cell.deleteCell, group:"tablecell", command:"cellDelete", order:15}, tablecell_merge:{label:l.cell.merge,
          ...
          group:"tablecellproperties", command:"cellProperties", order:21}, tablerow:{label:l.row.menu, group:"tablerow", order:1, getItems:function () {
        ...
        }}, tablerow_insertBefore:{label:l.row.insertBefore, group:"tablerow", command:"rowInsertBefore", order:5}, tablerow_insertAfter:{label:l.row.insertAfter, group:"tablerow", command:"rowInsertAfter", order:10}, tablerow_delete:{label:l.row.deleteRow,
          group:"tablerow", command:"rowDelete", order:15}, tablecolumn:{label:l.column.menu, group:"tablecolumn", order:1, getItems:function () {
        ...
        }}, tablecolumn_insertBefore:{label:l.column.insertBefore, group:"tablecolumn", command:"columnInsertBefore", order:5}, tablecolumn_insertAfter:{label:l.column.insertAfter, group:"tablecolumn", command:"columnInsertAfter", order:10}, tablecolumn_delete:{label:l.column.deleteColumn,
    ...
    (function () {
          ...
          if (e.data.space == b.config.toolbarLocation) {
            ...
            for (var l = b.toolbox.toolbars, n = a(b), o = 0; o < n.length; o++) {
              ...
              if (r) {
                ...
                if (r === "/")h.push('<span class="cke_toolbar_break"></span>'); else {
                  t = r.items || r;
                  for (var u = 0; u < t.length; u++) {
                    var v, w;
                    if (v = b.ui.create(t[u]))if (v.type == CKEDITOR.UI_SEPARATOR)q = i && v; else {
                      w = v.canGroup !== false;
                      if (!p) {
      ...
      CKEDITOR.ui.prototype.addToolbarGroup = function (a, c, f) {
        var e = b(this.editor), g = c === 0, h = {name:a};
        if (f) {
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("undo", {init:function (b) {
        ...
        var d = new a(b), h = b.addCommand("undo", {exec:function () {
          if (d.undo()) {
            b.selectionChange();
            this.fire("afterUndo")
          }
        }, state:CKEDITOR.TRISTATE_DISABLED, canUndo:false}), i = b.addCommand("redo", {exec:function () {
          if (d.redo()) {
            b.selectionChange();
            this.fire("afterRedo")
          }
      ...
      b.prototype = {equals:function (a, b) {
      ...
      var h = {8:1, 46:1}, d = {16:1, 17:1, 18:1}, i = {37:1, 38:1, 39:1, 40:1};
    ...
    CKEDITOR.plugins.add("wsc",
      {requires:"dialog", init:function (a) {
        ...
        a.ui.addButton && a.ui.addButton("SpellChecker", {label:a.lang.wsc.toolbar, command:"checkspell", toolbar:"spellchecker,10"});
    ...
    (function () {
      ...
      CKEDITOR.plugins.add("wysiwygarea", {init:function (a) {
        a.addMode("wysiwyg", function (b) {
          ...
          d.setAttributes({frameBorder:0, "aria-describedby":p, title:o, src:l, tabIndex:a.tabIndex, allowTransparency:"true"});
          !n && c();
          if (CKEDITOR.env.webkit) {
            l = function () {
      ...
      var d = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi, i = CKEDITOR.env.isCustomDomain(), f = CKEDITOR.tools.createClass({$:function (b) {
        this.base.apply(this, arguments);
