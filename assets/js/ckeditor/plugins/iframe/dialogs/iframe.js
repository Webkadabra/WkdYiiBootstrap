  ...
  CKEDITOR.dialog.add("iframe", function (b) {
    ...
    return{title:f.title, minWidth:350, minHeight:260, onShow:function () {
      ...
      {id:"info", label:a.generalTab, accessKey:"I", elements:[
        ...
        {type:"hbox", children:[
          {id:"width", type:"text", style:"width:100%", labelLayout:"vertical",
            label:a.width, validate:CKEDITOR.dialog.validate.htmlLength(a.invalidHtmlLength.replace("%1", a.width)), setup:c, commit:d},
          {id:"height", type:"text", style:"width:100%", labelLayout:"vertical", label:a.height, validate:CKEDITOR.dialog.validate.htmlLength(a.invalidHtmlLength.replace("%1", a.height)), setup:c, commit:d},
          {id:"align", type:"select", "default":"", items:[
            [a.notSet, ""],
            [a.alignLeft, "left"],
            [a.alignRight, "right"],
            [a.alignTop, "top"],
            ...
            labelLayout:"vertical", label:a.align, setup:function (a, b) {
        ...
        {type:"hbox", widths:["50%", "50%"], children:[
          {id:"scrolling", type:"checkbox", label:f.scrolling, setup:c, commit:d},
          {id:"frameborder", type:"checkbox", label:f.border, setup:c, commit:d}
        ]},
        {type:"hbox", widths:["50%", "50%"], children:[
          {id:"name", type:"text", label:a.name,
            setup:c, commit:d},
          {id:"title", type:"text", label:a.advisoryTitle, setup:c, commit:d}
        ]},
        {id:"longdesc", type:"text", label:a.longDescr, setup:c, commit:d}
      ]},
      e && e.createAdvancedTab(b, {id:1, classes:1, styles:1})
    ]}
  })
})();