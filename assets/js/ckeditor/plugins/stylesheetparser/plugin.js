...
(function () {
  function i(b, h, d) {
    ...
    for (a = 0; a < b.styleSheets.length; a++) {
      ...
      if (!(c.ownerNode || c.owningElement).getAttribute("data-cke-temp") && !(c.href && "chrome://" == c.href.substr(0, 9)))try {
    ...
    for (a = 0; a < b.length; a++)d = b[a].split("."), h = d[0].toLowerCase(), d = d[1], e.push({name:h + "." + d, element:h, attributes:{"class":d}});
    return e
  }
