 ...
 */
CKEDITOR.dialog.add("link", function (o) {
  var q, r;
  ...
  function u(a) {
    var g, c = q, d, e;
    g = [r, "("];
    for (var b = 0; b < c.length; b++)d = c[b].toLowerCase(), e = a[d], 0 < b && g.push(","), g.push("'", e ? s(encodeURIComponent(a[d])) : "", "'");
    g.push(")");
    return g.join("")
  }
  ...
  var x = CKEDITOR.plugins.link, t = function () {
      ...
      if (g && a)switch (g = g.getElement(), g.hide(), a.setValue(""), c) {
        case "frame":
          a.setLabel(o.lang.link.targetFrameName);
          a.getElement().show();
          break;
        case "popup":
          g.show();
          a.setLabel(o.lang.link.targetPopupName);
          a.getElement().show();
          break;
        default:
          a.setValue(c), a.getElement().hide()
      }
    }, y = /^javascript:/, z = /^mailto:([^?]+)(?:\?(.+))?$/,
    A = /subject=([^;?:@&=$,\/]*)/, B = /body=([^;?:@&=$,\/]*)/, C = /^#(.*)$/, D = /^((?:http|https|ftp|news):\/\/)?(.*)$/, E = /^(_(?:self|top|parent|blank))$/, F = /^javascript:void\(location\.href='mailto:'\+String\.fromCharCode\(([^)]+)\)(?:\+'(.*)')?\)$/, G = /^javascript:([^(]+)\(([^)]+)\)$/, H = /\s*window.open\(\s*this\.href\s*,\s*(?:'([^']*)'|null)\s*,\s*'([^']*)'\s*\)\s*;\s*return\s*false;*\s*/, I = /(?:^|,)([^=]+)=(\d+|yes|no)/gi, J = function (a, g) {
      var c = g && (g.data("cke-saved-href") || g.getAttribute("href")) || "", d, e, b =
      {};
      c.match(y) && ("encode" == p ? c = c.replace(F, function (a, c, b) {
        return"mailto:" + String.fromCharCode.apply(String, c.split(",")) + (b && b.replace(/\\'/g, "'"))
      }) : p && c.replace(G, function (a, c, d) {
        if (c == r) {
          b.type = "email";
          for (var a = b.email = {}, c = /(^')|('$)/g, d = d.match(/[^,\s]+/g), e = d.length, g, f, h = 0; h < e; h++)g = decodeURIComponent, f = d[h].replace(c, "").replace(/\\'/g, "'"), f = g(f), g = q[h].toLowerCase(), a[g] = f;
          a.address = [a.name, a.domain].join("@")
        }
      }));
      if (!b.type)if (d = c.match(C))b.type = "anchor", b.anchor = {}, b.anchor.name = b.anchor.id =
        d[1]; else if (d = c.match(z)) {
        e = c.match(A);
        c = c.match(B);
        b.type = "email";
        var f = b.email = {};
      ...
      } else c && (e = c.match(D)) ? (b.type = "url", b.url = {}, b.url.protocol = e[1], b.url.url = e[2]) : b.type = "url";
      if (g) {
        d = g.getAttribute("target");
        b.target = {};
        b.adv = {};
        if (d)d.match(E) ? b.target.type = b.target.name = d : (b.target.type = "frame", b.target.name = d); else if (d = (d = g.data("cke-pa-onclick") || g.getAttribute("onclick")) && d.match(H)) {
          b.target.type =
            "popup";
          for (b.target.name = d[1]; c = I.exec(d[2]);)("yes" == c[2] || "1" == c[2]) && !(c[1]in{height:1, width:1, top:1, left:1}) ? b.target[c[1]] = !0 : isFinite(c[2]) && (b.target[c[1]] = c[2])
        }
        d = function (a, c) {
        ...
        CKEDITOR.plugins.link.synAnchorSelector ?
          b.adv.advCSSClasses = w(g) : d("advCSSClasses", "class");
    ...
    }, p = o.config.emailProtection || "";
  p && "encode" != p && (r = q = void 0, p.replace(/^([^(]+)\(([^)]+)\)$/, function (a, b, c) {
    r = b;
    q = [];
  ...
  var i = o.lang.common, b = o.lang.link;
  return{title:b.title, minWidth:350, minHeight:230, contents:[
    {id:"info", label:b.info, title:b.info, elements:[
      {id:"linkType", type:"select", label:b.type, "default":"url", items:[
        ...
        if (c == "url") {
          o.config.linkShowTargetTab && a.showPage("target");
          d || a.showPage("upload")
        } else {
          a.hidePage("target");
          d || a.hidePage("upload")
      ...
      {type:"vbox", id:"urlOptions", children:[
        {type:"hbox", widths:["25%", "75%"], children:[
          ...
          {type:"text", id:"url", label:i.url, required:!0, onLoad:function () {
            ...
            return a.getContentElement("info", "linkType") && a.getValueOf("info", "linkType") != "url" || this.getDialog().fakeObj ?
      ...
      {type:"vbox", id:"anchorOptions", width:260, align:"center",
        padding:0, children:[
    ...
    {id:"target", label:b.target, title:b.target, elements:[
      {type:"hbox", widths:["50%", "50%"], children:[
        {type:"select", id:"linkTargetType",
          label:i.target, "default":"notSet", style:"width : 100%;", items:[
          [i.notSet, "notSet"],
          [b.targetFrame, "frame"],
          [b.targetPopup, "popup"],
          [i.targetNew, "_blank"],
      ...
      {type:"vbox", width:"100%", align:"center", padding:2, id:"popupFeatures", children:[
        {type:"fieldset", label:b.popupFeatures, children:[
          {type:"hbox", children:[
            {type:"checkbox", id:"resizable", label:b.popupResizable, setup:k, commit:m},
            {type:"checkbox", id:"status", label:b.popupStatusBar, setup:k, commit:m}
          ]},
          {type:"hbox", children:[
            {type:"checkbox", id:"location", label:b.popupLocationBar, setup:k, commit:m},
            {type:"checkbox",
              id:"toolbar", label:b.popupToolbar, setup:k, commit:m}
          ]},
          {type:"hbox", children:[
            {type:"checkbox", id:"menubar", label:b.popupMenuBar, setup:k, commit:m},
            {type:"checkbox", id:"fullscreen", label:b.popupFullScreen, setup:k, commit:m}
          ]},
          {type:"hbox", children:[
            {type:"checkbox", id:"scrollbars", label:b.popupScrollBars, setup:k, commit:m},
            {type:"checkbox", id:"dependent", label:b.popupDependent, setup:k, commit:m}
          ]},
          {type:"hbox", children:[
            {type:"text", widths:["50%", "50%"], labelLayout:"horizontal", label:i.width, id:"width",
              setup:k, commit:m},
            {type:"text", labelLayout:"horizontal", widths:["50%", "50%"], label:b.popupLeft, id:"left", setup:k, commit:m}
          ]},
          {type:"hbox", children:[
            {type:"text", labelLayout:"horizontal", widths:["50%", "50%"], label:i.height, id:"height", setup:k, commit:m},
            {type:"text", labelLayout:"horizontal", label:b.popupTop, widths:["50%", "50%"], id:"top", setup:k, commit:m}
          ]}
        ]}
      ]}
    ]},
    {id:"upload", label:b.upload, title:b.upload, hidden:!0, filebrowser:"uploadButton", elements:[
      {type:"file", id:"upload", label:i.upload, style:"height:40px",
        size:29},
    ...
    {id:"advanced", label:b.advanced, title:b.advanced, elements:[
      {type:"vbox", padding:1, children:[
        {type:"hbox", widths:["45%", "35%", "20%"], children:[
          {type:"text", id:"advId", label:b.id, setup:l, commit:n},
          {type:"select", id:"advLangDir", label:b.langDir, "default":"", style:"width:110px", items:[
            [i.notSet, ""],
            [b.langDirLTR, "ltr"],
            [b.langDirRTL, "rtl"]
          ], setup:l, commit:n},
          {type:"text", id:"advAccessKey",
            width:"80px", label:b.acccessKey, maxLength:1, setup:l, commit:n}
        ]},
        {type:"hbox", widths:["45%", "35%", "20%"], children:[
          {type:"text", label:b.name, id:"advName", setup:l, commit:n},
          {type:"text", label:b.langCode, id:"advLangCode", width:"110px", "default":"", setup:l, commit:n},
          {type:"text", label:b.tabIndex, id:"advTabIndex", width:"80px", maxLength:5, setup:l, commit:n}
        ]}
      ]},
      {type:"vbox", padding:1, children:[
        {type:"hbox", widths:["45%", "55%"], children:[
          {type:"text", label:b.advisoryTitle, "default":"", id:"advTitle", setup:l,
            commit:n},
          {type:"text", label:b.advisoryContentType, "default":"", id:"advContentType", setup:l, commit:n}
        ]},
        {type:"hbox", widths:["45%", "55%"], children:[
          {type:"text", label:b.cssClasses, "default":"", id:"advCSSClasses", setup:l, commit:n},
          {type:"text", label:b.charset, "default":"", id:"advCharset", setup:l, commit:n}
        ]},
        {type:"hbox", widths:["45%", "55%"], children:[
          {type:"text", label:b.rel, "default":"", id:"advRel", setup:l, commit:n},
          {type:"text", label:b.styles, "default":"", id:"advStyles", validate:CKEDITOR.dialog.validate.inlineStyle(o.lang.common.invalidInlineStyle),
            setup:l, commit:n}
        ]}
      ]}
    ]}
    ...
    (c = x.getSelectedLink(a)) && c.hasAttribute("href") ? b.selectElement(c) : c = null;
    this.setupContent(J.apply(this, [a, c]))
  }, onOk:function () {
    var a = {}, b = [], c = {}, d = this.getParentEditor();
    this.commitContent(c);
    switch (c.type || "url") {
      case "url":
        var e = c.url && c.url.protocol != void 0 ? c.url.protocol : "http://", j = c.url && CKEDITOR.tools.trim(c.url.url) || "";
        a["data-cke-saved-href"] = j.indexOf("/") === 0 ? j : e + j;
        break;
      case "anchor":
        e =
      ...
      case "email":
        ...
        switch (p) {
          case "":
          case "encode":
            var j = encodeURIComponent(f.subject || ""), h = encodeURIComponent(f.body || ""), f = [];
            j && f.push("subject=" + j);
            h && f.push("body=" + h);
            f = f.length ? "?" + f.join("&") : "";
            if (p == "encode") {
              e = ["javascript:void(location.href='mailto:'+", v(e)];
              f && e.push("+'", s(f), "'");
              e.push(")")
            } else e = ["mailto:", e, f];
            break;
    ...
    if (c.target)if (c.target.type == "popup") {
      for (var e = ["window.open(this.href, '", c.target.name || "", "', '"], i = ["resizable", "status", "location", "toolbar", "menubar", "fullscreen", "scrollbars", "dependent"], j = i.length, f = function (a) {
        c.target[a] && i.push(a + "=" + c.target[a])
      }, h = 0; h < j; h++)i[h] = i[h] + (c.target[i[h]] ? "=yes" : "=no");
      f("width");
      f("left");
      f("height");
      f("top");
      e.push(i.join(","), "'); return false;");
    ...
    if (this._.selectedElement) {
      ...
      if (j == f || c.type == "email" && f.indexOf("@") != -1)d.setHtml(c.type == "email" ? c.email.address : a["data-cke-saved-href"]);
      e.selectElement(d);
      delete this._.selectedElement
    } else {
      j =
        e.getRanges(true);
      if (j.length == 1 && j[0].collapsed) {
        f = new CKEDITOR.dom.text(c.type == "email" ? c.email.address : a["data-cke-saved-href"], d.document);
        j[0].insertNode(f);
        j[0].selectNodeContents(f);
        e.selectRanges(j)
      }
      e = new CKEDITOR.style({element:"a", attributes:a});
      e.type = CKEDITOR.STYLE_INLINE;
      d.applyStyle(e)
    }
  }, onLoad:function () {
    o.config.linkShowAdvancedTab || this.hidePage("advanced");
    o.config.linkShowTargetTab || this.hidePage("target")
  }, onFocus:function () {
