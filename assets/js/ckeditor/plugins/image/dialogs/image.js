        ...
        {type:"hbox", children:[
          {id:"basic", type:"vbox", children:[
            ...
            {type:"vbox", padding:1, children:[
              ...
              {type:"text", id:"txtVSpace", width:"60px", label:c.lang.image.vSpace, "default":"",
                onKeyUp:function () {
                  g(this.getDialog())
                }, onChange:function () {
                i.call(this, "advanced:txtdlgGenStyle")
                ...
                var e = parseInt(this.getValue(), 10);
                a == f || 4 == a ? (isNaN(e) ? !e && this.isChanged() &&
                  (b.removeStyle("margin-top"), b.removeStyle("margin-bottom")) : (b.setStyle("margin-top", CKEDITOR.tools.cssLength(e)), b.setStyle("margin-bottom", CKEDITOR.tools.cssLength(e))), !c && a == f && b.removeAttribute("vspace")) : 8 == a && (b.removeAttribute("vspace"), b.removeStyle("margin-top"), b.removeStyle("margin-bottom"))
              }},
