...
(function () {
  ...
  for (q in o)z[o[q]] = q, p.push(o[q].replace(/\(|\)|\:|\/|\*|\-|\|/g, function (a) {
    return"\\" + a
  }));
  ...
  CKEDITOR.BBCodeParser.prototype = {parse:function (a) {
    for (var b, c, i = 0; b = this._.bbcPartsRegex.exec(a);) {
      ...
      if ((c = (b[1] || b[3] || "").toLowerCase()) && !j[c])this.onText(b[0]); else if (b[1]) {
        var e = j[c], g = {}, h = {};
        if (b = b[2])if ("list" == c && (isNaN(b) ? /^[a-z]+$/.test(b) ? b = "lower-alpha" : /^[A-Z]+$/.test(b) && (b = "upper-alpha") : b = "decimal"), w[c]) {
          "size" == c && (b += "%");
          h[w[c]] = b;
          b = g;
          var f = "", d = void 0;
          for (d in h)var r = (d + ":" + h[d]).replace(A, ";"),
            f = f + r;
          b.style = f
        } else x[c] && (g[x[c]] = b);
  ...
  CKEDITOR.htmlParser.fragment.fromBBCode = function (a) {
    ...
    e.onText = function (e) {
      ...
      if (!a || a["#"])c(), b(), e.replace(/([\r\n])|[^\r\n]*/g, function (e, a) {
        if (void 0 !== a && a.length)f++; else if (e.length) {
          var b = 0;
          e.replace(p,
            function (a, c) {
    ...
    for (e.parse(CKEDITOR.tools.htmlEncode(a)); d.type;)a = d.parent, i(d, a), d = a;
    return g
  };
  ...
  CKEDITOR.plugins.add("bbcode", {requires:"entities", beforeInit:function (a) {
    ...
    i.addRules({elements:{blockquote:function (a) {
      ...
      var b;
      if (b = a.attributes.bbcode)"img" == b ? (a.name = "img", a.attributes.src = a.children[0].value, a.children = []) : "email" == b &&
    ...
    a.dataProcessor.htmlFilter.addRules({elements:{$:function (b) {
      ...
      if (d in v)d = v[d]; else if ("span" == d)if (f = h.color)d = "color", f = CKEDITOR.tools.convertRgbToHex(f); else {
      ...
      if ((a = a.next) && a.name in y)return!1
    }}}, 1);
